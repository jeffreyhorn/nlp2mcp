...
.PHONY: regen-goldens check-goldens check-index-repeats
regen-goldens:
...
# P1/P2 repeated-index properties over the committed goldens (Sprint 39 P10).
# P1 is a hard gate (0 violations); P2 ratchets against
