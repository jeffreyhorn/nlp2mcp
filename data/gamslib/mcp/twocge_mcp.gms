...
stat_e(i,r).. pwe(i,r) * nu_eqepsilon(r) + ((-1) * (theta(i,r) * (xie(i,r) * e(i,r) ** phi(i) + xid(i,r) * d(i,r) ** phi(i)) ** (1 / phi(i)) * 1 / phi(i) / (xie(i,r) * e(i,r) ** phi(i) + xid(i,r) * d(i,r) ** phi(i)) * xie(i,r) * e(i,r) ** phi(i) * phi(i) / e(i,r))) * nu_eqpzd(i,r) + nu_eqE(i,r) + sum(rr, 1$(ord(r) <> ord(r)) * nu_eqw(i,r,rr)) - piL_e(i,r) =E= 0;
...
stat_m(i,r).. ((-1) * (taum(i,r) * pm(i,r))) * nu_eqTm(i,r) + ((-1) * pwm(i,r)) * nu_eqepsilon(r) + ((-1) * (gamma(i, r) * (deltam(i,r) * m(i,r) ** eta(i) + deltad(i,r) * d(i,r) ** eta(i)) ** (1 / eta(i)) * 1 / eta(i) / (deltam(i,r) * m(i,r) ** eta(i) + deltad(i,r) * d(i,r) ** eta(i)) * deltam(i,r) * m(i,r) ** eta(i) * eta(i) / m(i,r))) * nu_eqpqs(i,r) + nu_eqM(i,r) + sum(rr, (-1)$(ord(r) <> ord(r)) * nu_eqw(i,r,rr)) - piL_m(i,r) =E= 0;
...
stat_pwe(i,r).. ((-1) * epsilon(r)) * nu_eqpe(i,r) + e(i,r) * nu_eqepsilon(r) + sum(rr, 1$(ord(r) <> ord(r)) * nu_eqpw(i,r,rr)) - piL_pwe(i,r) =E= 0;
stat_pwm(i,r).. ((-1) * epsilon(r)) * nu_eqpm(i,r) + ((-1) * m(i,r)) * nu_eqepsilon(r) + sum(rr, (-1)$(ord(r) <> ord(r)) * nu_eqpw(i,r,rr)) - piL_pwm(i,r) =E= 0;
...
stat_tz(j,r).. nu_eqTz(j,r) + ((-1) * (pq(j,r) * mu(j,r) / sqr(pq(j,r)))) * nu_eqXg(j,r) + (((-1) * (pq(j,r) * mu(j+1,r) / sqr(pq(j,r)))) * nu_eqXg(j+1,r))$(ord(j) <= card(j) - 1) + (((-1) * (pq(j,r) * mu(j-1,r) / sqr(pq(j,r)))) * nu_eqXg(j-1,r))$(ord(j) > 1) + ((-1) * ssg(r)) * nu_eqSg(r) - piL_tz(j,r) =E= 0;
