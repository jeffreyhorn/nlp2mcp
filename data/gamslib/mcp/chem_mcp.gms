...
Parameters
    a(i,c) /H.H 1, H.H2 2, H.H2O 2, H.NH 1, H.OH 1, N.N 1, N.N2 2, N.NH 1, N.'NO' 1, O.H2O 1, O.'NO' 1, O.O 1, O.O2 2, O.OH 1/
    mix(i) /h 2, n 1, o 1/
...
stat_xb.. sum(c, x(c) * 1 / (x(c) / xb) * ((-1) * x(c)) / sqr(xb)) + nu_xdef - piL_xb =E= 0;
