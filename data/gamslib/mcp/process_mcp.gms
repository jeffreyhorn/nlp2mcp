...
stat_alkylate.. -(octane * 0.063) + 1 * nu_yield + 1.22 * nu_makeup + -(1000 * (98 - strength) * strength * dilute / (98 - strength) ** 2 / 1000000) * nu_sdef + 0 * nu_motor + 0 * nu_drat + 0 * nu_ddil + 0 * nu_df4 + rangey * nu_rngyield + 0 * nu_rngmotor + 0 * nu_rngddil + 0 * nu_rngdf4 + piU_alkylate =E= 0;
stat_dilute.. 0 + 0 * nu_yield + 0 * nu_makeup + -(1000 * (98 - strength) * strength * alkylate / (98 - strength) ** 2 / 1000000) * nu_sdef + 0 * nu_motor + 0 * nu_drat + 1 * nu_ddil + 0 * nu_df4 + 0 * nu_rngyield + 0 * nu_rngmotor + ranged * nu_rngddil + 0 * nu_rngdf4 - piL_dilute + piU_dilute =E= 0;
...
stat_isom.. 3.36 + 0 * nu_yield + (-1) * nu_makeup + 0 * nu_sdef + 0 * nu_motor + -(1 / olefin ** 1) * nu_drat + 0 * nu_ddil + 0 * nu_df4 + 0 * nu_rngyield + 0 * nu_rngmotor + 0 * nu_rngddil + 0 * nu_rngdf4 + piU_isom =E= 0;
stat_isor.. 0.035 + 0 * nu_yield + 0 * nu_makeup + 0 * nu_sdef + 0 * nu_motor + -(1 / olefin ** 1) * nu_drat + 0 * nu_ddil + 0 * nu_df4 + 0 * nu_rngyield + 0 * nu_rngmotor + 0 * nu_rngddil + 0 * nu_rngdf4 + piU_isor =E= 0;
stat_octane.. -(0.063 * alkylate) + 0 * nu_yield + 0 * nu_makeup + 0 * nu_sdef + 1 * nu_motor + 0 * nu_drat + 0 * nu_ddil + (-3) * nu_df4 + 0 * nu_rngyield + rangem * nu_rngmotor + 0 * nu_rngddil + (-3) * nu_rngdf4 - piL_octane + piU_octane =E= 0;
stat_olefin.. 5.04 + -(1.12 + 0.13167 * ratio - 0.00667 * sqr(ratio)) * nu_yield + (-1) * nu_makeup + 0 * nu_sdef + 0 * nu_motor + -(-(isor + isom) / olefin ** 2) * nu_drat + 0 * nu_ddil + 0 * nu_df4 + -(1.12 + 0.13167 * ratio - 0.00667 * sqr(ratio)) * nu_rngyield + 0 * nu_rngmotor + 0 * nu_rngddil + 0 * nu_rngdf4 - piL_olefin + piU_olefin =E= 0;
...
stat_ratio.. 0 + -(olefin * (0.13167 - 0.00667 * 2 * ratio)) * nu_yield + 0 * nu_makeup + 0 * nu_sdef + -(1.098 - 0.038 * 2 * ratio) * nu_motor + 1 * nu_drat + 0 * nu_ddil + 0 * nu_df4 + -(olefin * (0.13167 - 0.00667 * 2 * ratio)) * nu_rngyield + -(1.098 - 0.038 * 2 * ratio) * nu_rngmotor + 0 * nu_rngddil + 0 * nu_rngdf4 - piL_ratio + piU_ratio =E= 0;
stat_strength.. 0 + 0 * nu_yield + 0 * nu_makeup + -(1000 * ((98 - strength) * alkylate * dilute - alkylate * dilute * strength * -1) / (98 - strength) ** 2 / 1000000) * nu_sdef + (-0.325) * nu_motor + 0 * nu_drat + 0 * nu_ddil + 0 * nu_df4 + 0 * nu_rngyield + (-0.325) * nu_rngmotor + 0 * nu_rngddil + 0 * nu_rngdf4 - piL_strength + piU_strength =E= 0;
