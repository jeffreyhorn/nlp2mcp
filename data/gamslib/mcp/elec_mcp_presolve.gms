...
stat_z(i).. sum(j__$(ut(i,j__)), ((-1) * (1 / (2 * sqrt(sqr(x(i) - x(j__)) + sqr(y(i) - y(j__)) + sqr(z(i) - z(j__)))) * 2 * (z(i) - z(j__)))) / sqr(sqrt(sqr(x(i) - x(j__)) + sqr(y(i) - y(j__)) + sqr(z(i) - z(j__))))) + sum(i__$(ut(i__,i)), ((-1) * (1 / (2 * sqrt(sqr(x(i__) - x(i)) + sqr(y(i__) - y(i)) + sqr(z(i__) - z(i)))) * 2 * (z(i__) - z(i)) * (-1))) / sqr(sqrt(sqr(x(i__) - x(i)) + sqr(y(i__) - y(i)) + sqr(z(i__) - z(i))))) + 2 * z(i) * nu_ball(i) =E= 0;
