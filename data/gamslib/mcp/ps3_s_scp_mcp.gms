...
stat_x(i).. ((-1) * (0.5 * x(i) ** (-0.5))) * nu_rev(i) + (1 - theta(i) + sqr(theta(i))) * lam_pc(i) + (1 - theta(i) + sqr(theta(i))) * lam_licd(i) + (((-1) * (1 - theta(i-1) + sqr(theta(i-1)))) * lam_licd(i-1))$(ord(i) > 1) + (1 - theta(i) + sqr(theta(i))) * lam_licu(i) + (((-1) * (1 - theta(i+1) + sqr(theta(i+1)))) * lam_licu(i+1))$(ord(i) <= card(i) - 1) - piL_x(i) =E= 0;

* Inequality complementarity equations
comp_licd(i).. w(i) - (theta(i) + (1 - theta(i) + sqr(theta(i))) * x(i)) - (w(i+1) - (theta(i) + (1 - theta(i) + sqr(theta(i))) * x(i+1))) =G= 0;
comp_licu(i).. w(i) - (theta(i) + (1 - theta(i) + sqr(theta(i))) * x(i)) - (w(i-1) - (theta(i) + (1 - theta(i) + sqr(theta(i))) * x(i-1))) =G= 0;
