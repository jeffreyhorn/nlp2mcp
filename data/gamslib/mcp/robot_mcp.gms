...
phi_dot.fx(h)$(not ((ord(h) > 1) or (sameas(h, 'h0')) or (sameas(h, 'h50')))) = 0;
rho_dot.fx(h)$(not ((ord(h) > 1) or (sameas(h, 'h0')) or (sameas(h, 'h50')))) = 0;
the_dot.fx(h)$(not ((ord(h) > 1) or (sameas(h, 'h0')) or (sameas(h, 'h50')))) = 0;
