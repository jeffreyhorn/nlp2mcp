...
Parameters
    a(cr,c,p) /'mid-c'.crude.'a-dist' -1.0, 'mid-c'.'sr-gas'.'a-dist' 0.236, 'mid-c'.'sr-naphtha'.'a-dist' 0.223, 'mid-c'.'sr-naphtha'.'n-reform' -1.0, 'mid-c'.'sr-dist'.'a-dist' 0.087, 'mid-c'.'sr-dist'.'cc-dist' -1.0, 'mid-c'.'sr-gas-oil'.'a-dist' 0.111, 'mid-c'.'sr-gas-oil'.'cc-gas-oil' -1.0, 'mid-c'.'sr-res'.'a-dist' 0.315, 'mid-c'.'rf-gas'.'n-reform' 0.807, 'mid-c'.'fuel-gas'.'a-dist' 0.029, 'mid-c'.'fuel-gas'.'n-reform' 0.129, 'mid-c'.'fuel-gas'.'cc-dist' 0.3, 'mid-c'.'fuel-gas'.'cc-gas-oil' 0.31, 'mid-c'.'cc-gas'.'cc-dist' 0.59, 'mid-c'.'cc-gas'.'cc-gas-oil' 0.59, 'mid-c'.'cc-gas-oil'.'cc-dist' 0.21, 'mid-c'.'cc-gas-oil'.'cc-gas-oil' 0.22, 'w-tex'.crude.'a-dist' -1.0, 'w-tex'.'sr-gas'.'a-dist' 0.18, 'w-tex'.'sr-naphtha'.'a-dist' 0.196, 'w-tex'.'sr-naphtha'.'n-reform' -1.0, 'w-tex'.'sr-dist'.'a-dist' 0.073, 'w-tex'.'sr-dist'.'cc-dist' -1.0, 'w-tex'.'sr-gas-oil'.'a-dist' 0.091, 'w-tex'.'sr-gas-oil'.'cc-gas-oil' -1.0, 'w-tex'.'sr-res'.'a-dist' 0.443, 'w-tex'.'sr-res'.'cc-gas-oil' -1.0, 'w-tex'.'rf-gas'.'n-reform' 0.836, 'w-tex'.'fuel-gas'.'a-dist' 0.017, 'w-tex'.'fuel-gas'.'n-reform' 0.099, 'w-tex'.'fuel-gas'.'cc-dist' 0.36, 'w-tex'.'fuel-gas'.'cc-gas-oil' 0.38, 'w-tex'.'cc-gas'.'cc-dist' 0.58, 'w-tex'.'cc-gas'.'cc-gas-oil' 0.6, 'w-tex'.'cc-gas-oil'.'cc-dist' 0.15, 'w-tex'.'cc-gas-oil'.'cc-gas-oil' 0.15, 'w-tex'.'hydro-res'.'cc-gas-oil' 0.97, 'w-tex'.'sr-res'.'n-reform' 0.0, 'w-tex'.'sr-res'.'cc-dist' 0.0, 'w-tex'.'sr-res'.hydro 0.0, 'mid-c'.'sr-dist'.'n-reform' 0.0, 'mid-c'.'sr-dist'.'cc-gas-oil' 0.0, 'mid-c'.'sr-dist'.hydro 0.0, 'w-tex'.'sr-naphtha'.'cc-dist' 0.0, 'w-tex'.'sr-naphtha'.'cc-gas-oil' 0.0, 'w-tex'.'sr-naphtha'.hydro 0.0, 'w-tex'.'sr-gas-oil'.'n-reform' 0.0, 'w-tex'.'sr-gas-oil'.'cc-dist' 0.0, 'w-tex'.'sr-gas-oil'.hydro 0.0, 'w-tex'.'cc-gas'.'a-dist' 0.0, 'w-tex'.'cc-gas'.'n-reform' 0.0, 'w-tex'.'cc-gas'.hydro 0.0, 'w-tex'.crude.'n-reform' 0.0, 'w-tex'.crude.'cc-dist' 0.0, 'w-tex'.crude.'cc-gas-oil' 0.0, 'w-tex'.crude.hydro 0.0, 'w-tex'.'sr-gas'.'n-reform' 0.0, 'w-tex'.'sr-gas'.'cc-dist' 0.0, 'w-tex'.'sr-gas'.'cc-gas-oil' 0.0, 'w-tex'.'sr-gas'.hydro 0.0, 'w-tex'.'sr-dist'.'n-reform' 0.0, 'w-tex'.'sr-dist'.'cc-gas-oil' 0.0, 'w-tex'.'sr-dist'.hydro 0.0, 'mid-c'.'rf-gas'.'a-dist' 0.0, 'mid-c'.'rf-gas'.'cc-dist' 0.0, 'mid-c'.'rf-gas'.'cc-gas-oil' 0.0, 'mid-c'.'rf-gas'.hydro 0.0, 'w-tex'.'rf-gas'.'a-dist' 0.0, 'w-tex'.'rf-gas'.'cc-dist' 0.0, 'w-tex'.'rf-gas'.'cc-gas-oil' 0.0, 'w-tex'.'rf-gas'.hydro 0.0, 'w-tex'.'cc-gas-oil'.'a-dist' 0.0, 'w-tex'.'cc-gas-oil'.'n-reform' 0.0, 'w-tex'.'cc-gas-oil'.hydro 0.0, 'mid-c'.'fuel-gas'.hydro 0.0, 'mid-c'.'sr-naphtha'.'cc-dist' 0.0, 'mid-c'.'sr-naphtha'.'cc-gas-oil' 0.0, 'mid-c'.'sr-naphtha'.hydro 0.0, 'mid-c'.'cc-gas-oil'.'a-dist' 0.0, 'mid-c'.'cc-gas-oil'.'n-reform' 0.0, 'mid-c'.'cc-gas-oil'.hydro 0.0, 'mid-c'.crude.'n-reform' 0.0, 'mid-c'.crude.'cc-dist' 0.0, 'mid-c'.crude.'cc-gas-oil' 0.0, 'mid-c'.crude.hydro 0.0, 'w-tex'.'fuel-gas'.hydro 0.0, 'mid-c'.'sr-gas'.'n-reform' 0.0, 'mid-c'.'sr-gas'.'cc-dist' 0.0, 'mid-c'.'sr-gas'.'cc-gas-oil' 0.0, 'mid-c'.'sr-gas'.hydro 0.0, 'w-tex'.'hydro-res'.'a-dist' 0.0, 'w-tex'.'hydro-res'.'n-reform' 0.0, 'w-tex'.'hydro-res'.'cc-dist' 0.0, 'w-tex'.'hydro-res'.hydro 0.0, 'mid-c'.'cc-gas'.'a-dist' 0.0, 'mid-c'.'cc-gas'.'n-reform' 0.0, 'mid-c'.'cc-gas'.hydro 0.0, 'mid-c'.'sr-gas-oil'.'n-reform' 0.0, 'mid-c'.'sr-gas-oil'.'cc-dist' 0.0, 'mid-c'.'sr-gas-oil'.hydro 0.0, 'mid-c'.'sr-res'.'n-reform' 0.0, 'mid-c'.'sr-res'.'cc-dist' 0.0, 'mid-c'.'sr-res'.'cc-gas-oil' 0.0, 'mid-c'.'sr-res'.hydro 0.0/
    b(m,p) /'a-still'.'a-dist' 1.0, reformer.'n-reform' 1.0, 'c-crack'.'cc-dist' 1.0, 'c-crack'.'cc-gas-oil' 1.0, reformer.'a-dist' 0.0, reformer.'cc-dist' 0.0, reformer.'cc-gas-oil' 0.0, 'c-crack'.'a-dist' 0.0, 'c-crack'.'n-reform' 0.0, 'a-still'.'n-reform' 0.0, 'a-still'.'cc-dist' 0.0, 'a-still'.'cc-gas-oil' 0.0/
    ...
    qs(lim,cf,q) /lower.premium.octane 90.0, lower.regular.octane 86.0, upper.premium.'vapor-pr' 12.7, upper.regular.'vapor-pr' 12.7, upper.distillate.density 306.0, upper.distillate.sulfur 0.5, upper.'fuel-oil'.density 352.0, upper.'fuel-oil'.sulfur 3.5, lower.premium.'vapor-pr' 0.0, lower.premium.density 0.0, lower.premium.sulfur 0.0, upper.premium.octane 0.0, upper.premium.density 0.0, upper.premium.sulfur 0.0, lower.regular.'vapor-pr' 0.0, lower.regular.density 0.0, lower.regular.sulfur 0.0, upper.distillate.octane 0.0, upper.distillate.'vapor-pr' 0.0, upper.'fuel-oil'.octane 0.0, upper.'fuel-oil'.'vapor-pr' 0.0, upper.regular.octane 0.0, upper.regular.density 0.0, upper.regular.sulfur 0.0, upper.'fuel-oil'.sulfur 3.4/
