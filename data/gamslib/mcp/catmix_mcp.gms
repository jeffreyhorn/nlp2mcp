...
stat_u(nh).. sum(i, alpha * h * 2 * (u(0+1) - u(nh)) * (-1) * 1$(nh(i))) + (((-1) * (h / 2 * (10 * x2(nh) - x1(nh)))) * nu_ode1(nh))$(nh(nh)) + ((((-1) * (h / 2 * (10 * x2(nh) - x1(nh)))) * nu_ode1(nh-1))$(ord(nh) > 1))$(nh(nh)) + (((-1) * (h / 2 * (x1(nh) - 10 * x2(nh) - x2(nh) * (-1)))) * nu_ode2(nh))$(nh(nh)) + ((((-1) * (h / 2 * (x1(nh) - 10 * x2(nh) - x2(nh) * (-1)))) * nu_ode2(nh-1))$(ord(nh) > 1))$(nh(nh)) - piL_u(nh) + piU_u(nh) =E= 0;
