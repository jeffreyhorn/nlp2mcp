...
stat_nd(i).. ((-1) * pnd(i)) * nu_valuen(i) + ((-1) * (an(i) * (deltan(i) * nd(i) ** ((-1) * rhon(i)) + (1 - deltan(i)) * nm(i) ** ((-1) * rhon(i))) ** ((-1) / rhon(i)) * (-1) / rhon(i) / (deltan(i) * nd(i) ** ((-1) * rhon(i)) + (1 - deltan(i)) * nm(i) ** ((-1) * rhon(i))) * deltan(i) * nd(i) ** ((-1) * rhon(i)) * ((-1) * rhon(i)) / nd(i))) * nu_prodn(i) + nu_firstn(i) + ((-1) * a(i,i)) * nu_equil(i) + (((-1) * a(i,i)) * nu_equil(i+2))$(ord(i) <= card(i) - 2) + (((-1) * a(i,i)) * nu_equil(i+1))$(ord(i) <= card(i) - 1) + (((-1) * a(i,i)) * nu_equil(i+3))$(ord(i) <= card(i) - 3) + (((-1) * a(i,i)) * nu_equil(i+4))$(ord(i) <= card(i) - 4) + (((-1) * a(i,i)) * nu_equil(i+5))$(ord(i) <= card(i) - 5) + (((-1) * a(i,i)) * nu_equil(i-2))$(ord(i) > 2) + (((-1) * a(i,i)) * nu_equil(i-1))$(ord(i) > 1) + (((-1) * a(i,i)) * nu_equil(i-3))$(ord(i) > 3) + (((-1) * a(i,i)) * nu_equil(i-4))$(ord(i) > 4) + (((-1) * a(i,i)) * nu_equil(i-5))$(ord(i) > 5) - piL_nd(i) =E= 0;
...
stat_pc(i).. nu_pcdet(i) + sum(r, ((-1) * ch(i,r)) * nu_cpidet(r)) + sum(r, ((-1) * (pop(r) * ac(i,r) * (mc(r) - sum(j, pc00(j) * gamma(j, r))) * prod(j, (pc(j) / pc00(j)) ** ac(j,r)) * sum(j, (pc(j) / pc00(j)) ** ac(j,r) * ac(j,r) / (pc(j) / pc00(j)) * 1 / pc00(j) ** 1 / (pc(j) / pc00(j)) ** ac(j,r)))) * nu_les(i,r)) + (ch(i,r) - pop("rural") * (gamma(i, r) + ac(i,"rural") * (mc(r) - sum(j, pc00(j) * gamma(j, r))) * prod(j, (pc(j) / pc00(j)) ** ac(j,r)) * sum(j, (pc(j) / pc00(j)) ** ac(j,r) * ac(j,r) / (pc(j) / pc00(j)) * 1 / pc00(j) ** 1 / (pc(j) / pc00(j)) ** ac(j,r))) + pop("rural") * ac(i,"rural") * (mc(r) - sum(j, pc00(j) * gamma(j, r))) * prod(j, (pc(j) / pc00(j)) ** ac(j,r)) * sum(j, (pc(j) / pc00(j)) ** ac(j,r) * ac(j,r) / (pc(j) / pc00(j)) * 1 / pc00(j) ** 1 / (pc(j) / pc00(j)) ** ac(j,r))) * nu_les(i) + sum(r, ch(i,r) * nu_hbudget(r)) + sum(i__, pc00(i__) * aid(i__)) * savf / usdefl * er00 / er * aid(i) / sqr(sum(i__, pc00(i__) * aid(i__))) * nu_fbudget + (sum(i__, pc00(i__) * aid(i__)) * savf / usdefl * er00 / er * aid(i) / sqr(sum(i__, pc00(i__) * aid(i__))) - id(i)) * nu_invsav - piL_pc(i) =E= 0;
...
stat_pq(i).. q(i) * nu_valueq(i) + ((-1) * ((1 + tnd(i)) * a(i,i))) * nu_pnddet(i) + (((-1) * ((1 + tnd(i)) * a(i,i))) * nu_pnddet(i+2))$(ord(i) <= card(i) - 2) + (((-1) * ((1 + tnd(i)) * a(i,i))) * nu_pnddet(i+1))$(ord(i) <= card(i) - 1) + (((-1) * ((1 + tnd(i)) * a(i,i))) * nu_pnddet(i+3))$(ord(i) <= card(i) - 3) + (((-1) * ((1 + tnd(i)) * a(i,i))) * nu_pnddet(i+4))$(ord(i) <= card(i) - 4) + (((-1) * ((1 + tnd(i)) * a(i,i))) * nu_pnddet(i+5))$(ord(i) <= card(i) - 5) + (((-1) * ((1 + tnd(i)) * a(i,i))) * nu_pnddet(i-2))$(ord(i) > 2) + (((-1) * ((1 + tnd(i)) * a(i,i))) * nu_pnddet(i-1))$(ord(i) > 1) + (((-1) * ((1 + tnd(i)) * a(i,i))) * nu_pnddet(i-3))$(ord(i) > 3) + (((-1) * ((1 + tnd(i)) * a(i,i))) * nu_pnddet(i-4))$(ord(i) > 4) + (((-1) * ((1 + tnd(i)) * a(i,i))) * nu_pnddet(i-5))$(ord(i) > 5) + ((-1) * (1 + tfd(i) + trmd(i))) * nu_pcdet(i) + ((-1) * (exscale * aex(i) * (er00 * pie(i) / (pq(i) * (1 + trmx(i)))) ** eta(i) * eta(i) / (er00 * pie(i) / (pq(i) * (1 + trmx(i)))) * ((-1) * (er00 * pie(i) * (1 + trmx(i)))) / sqr(pq(i) * (1 + trmx(i))))) * nu_export(i) + ((-1) * (fd(i) * trmd(i))) * nu_margdet + ((-1) * dst(i)) * nu_invsav - piL_pq(i) =E= 0;
...
stat_tnd(i).. ((-1) * (a(i,i) * pq(i))) * nu_pnddet(i) + (((-1) * (a(i,i) * pq(i))) * nu_pnddet(i+2))$(ord(i) <= card(i) - 2) + (((-1) * (a(i,i) * pq(i))) * nu_pnddet(i+1))$(ord(i) <= card(i) - 1) + (((-1) * (a(i,i) * pq(i))) * nu_pnddet(i+3))$(ord(i) <= card(i) - 3) + (((-1) * (a(i,i) * pq(i))) * nu_pnddet(i+4))$(ord(i) <= card(i) - 4) + (((-1) * (a(i,i) * pq(i))) * nu_pnddet(i+5))$(ord(i) <= card(i) - 5) + (((-1) * (a(i,i) * pq(i))) * nu_pnddet(i-2))$(ord(i) > 2) + (((-1) * (a(i,i) * pq(i))) * nu_pnddet(i-1))$(ord(i) > 1) + (((-1) * (a(i,i) * pq(i))) * nu_pnddet(i-3))$(ord(i) > 3) + (((-1) * (a(i,i) * pq(i))) * nu_pnddet(i-4))$(ord(i) > 4) + (((-1) * (a(i,i) * pq(i))) * nu_pnddet(i-5))$(ord(i) > 5) =E= 0;
stat_tnm(i).. ((-1) * (am(i,i) * pim(i))) * nu_pnmdet(i) + (((-1) * (am(i,i) * pim(i))) * nu_pnmdet(i+2))$(ord(i) <= card(i) - 2) + (((-1) * (am(i,i) * pim(i))) * nu_pnmdet(i+1))$(ord(i) <= card(i) - 1) + (((-1) * (am(i,i) * pim(i))) * nu_pnmdet(i+3))$(ord(i) <= card(i) - 3) + (((-1) * (am(i,i) * pim(i))) * nu_pnmdet(i+4))$(ord(i) <= card(i) - 4) + (((-1) * (am(i,i) * pim(i))) * nu_pnmdet(i+5))$(ord(i) <= card(i) - 5) + (((-1) * (am(i,i) * pim(i))) * nu_pnmdet(i-2))$(ord(i) > 2) + (((-1) * (am(i,i) * pim(i))) * nu_pnmdet(i-1))$(ord(i) > 1) + (((-1) * (am(i,i) * pim(i))) * nu_pnmdet(i-3))$(ord(i) > 3) + (((-1) * (am(i,i) * pim(i))) * nu_pnmdet(i-4))$(ord(i) > 4) + (((-1) * (am(i,i) * pim(i))) * nu_pnmdet(i-5))$(ord(i) > 5) =E= 0;
