...
stat_nd(i).. ((-1) * pnd(i)) * nu_valuen(i) + ((-1) * (an(i) * (deltan(i) * nd(i) ** ((-1) * rhon(i)) + (1 - deltan(i)) * nm(i) ** ((-1) * rhon(i))) ** ((-1) / rhon(i)) * (-1) / rhon(i) / (deltan(i) * nd(i) ** ((-1) * rhon(i)) + (1 - deltan(i)) * nm(i) ** ((-1) * rhon(i))) * deltan(i) * nd(i) ** ((-1) * rhon(i)) * ((-1) * rhon(i)) / nd(i))) * nu_prodn(i) + nu_firstn(i) + sum(j, (-1) * a(j,i) * nu_equil(j)) - piL_nd(i) =E= 0;
...
stat_pq(i).. q(i) * nu_valueq(i) + sum(j, (-1) * (1 + tnd(i)) * a(i,j) * nu_pnddet(j)) + ((-1) * (1 + tfd(i) + trmd(i))) * nu_pcdet(i) + (((-1) * (exscale * aex(i) * (er00 * pie(i) / (pq(i) * (1 + trmx(i)))) ** eta(i) * eta(i) / (er00 * pie(i) / (pq(i) * (1 + trmx(i)))) * ((-1) * (er00 * pie(i) * (1 + trmx(i)))) / sqr(pq(i) * (1 + trmx(i))))) * nu_export(i))$(ie(i)) + (((-1) * (fd(i) * trmd(i) + ex(i) * trmx(i))) * nu_margdet)$(sameas(i, 'agricult') or sameas(i, 'cap-good') or sameas(i, 'cons-good') or sameas(i, 'int-good') or sameas(i, 'pub-infr')) + ((marg - (fd(i) * trmd(i) + ex(i) * trmx(i))) * nu_margdet)$(sameas(i, 'service')) + ex(i) * (1 + trmx(i)) * nu_fbudget + (((-1) * dst(i)) * nu_invsav)$(sameas(i, 'agricult') or sameas(i, 'cap-good') or sameas(i, 'cons-good') or sameas(i, 'int-good') or sameas(i, 'service')) + (((-1) * (dst(i) + sum(i__, g(i__)))) * nu_invsav)$(sameas(i, 'pub-infr')) - piL_pq(i) =E= 0;
...
stat_tnd(i).. sum(j, (-1) * a(i,j) * pq(i) * nu_pnddet(j)) =E= 0;
stat_tnm(i).. sum(j, (-1) * am(i,j) * pim(i) * nu_pnmdet(j)) =E= 0;
