...
stat_t(n,np).. ((pairs(n,np,"kappa") + 3 * tm * pairs(n,np,"nu") * power(t(n,np), 2)) * 1$(arc(n,np)) + ((-1) * 1$(arc(n,np))) * nu_nbal(n) + (((1$(arc(np,np)) * nu_nbal(n-1))$(ord(n) > 1))$(ord(np) = 1))$((sameas(n, 'five') or sameas(n, 'four') or sameas(n, 'six') or sameas(n, 'three') or sameas(n, 'two')) and (sameas(np, 'five') or sameas(np, 'four') or sameas(np, 'one') or sameas(np, 'three') or sameas(np, 'two'))) + (((1$(arc(np,np)) * nu_nbal(n-4))$(ord(n) > 4))$(ord(np) = 4))$((sameas(n, 'five') or sameas(n, 'six')) and (sameas(np, 'one') or sameas(np, 'two'))) + (((1$(arc(np,np)) * nu_nbal(n+1))$(ord(n) <= card(n) - 1))$(ord(np) = 1))$((sameas(n, 'five') or sameas(n, 'four') or sameas(n, 'one') or sameas(n, 'three') or sameas(n, 'two')) and (sameas(np, 'five') or sameas(np, 'four') or sameas(np, 'six') or sameas(np, 'three') or sameas(np, 'two'))) + (((1$(arc(np,np)) * nu_nbal(n-2))$(ord(n) > 2))$(ord(np) = 2))$((sameas(n, 'five') or sameas(n, 'four') or sameas(n, 'six') or sameas(n, 'three')) and (sameas(np, 'four') or sameas(np, 'one') or sameas(np, 'three') or sameas(np, 'two'))) + (((1$(arc(np,np)) * nu_nbal(n-3))$(ord(n) > 3))$(ord(np) = 3))$((sameas(n, 'five') or sameas(n, 'four') or sameas(n, 'six')) and l(np)) + (((1$(arc(np,np)) * nu_nbal(n+2))$(ord(n) <= card(n) - 2))$(ord(np) = 2))$((sameas(n, 'four') or sameas(n, 'one') or sameas(n, 'three') or sameas(n, 'two')) and (sameas(np, 'five') or sameas(np, 'four') or sameas(np, 'six') or sameas(np, 'three'))) + (((1$(arc(np,np)) * nu_nbal(n+4))$(ord(n) <= card(n) - 4))$(ord(np) = 4))$((sameas(n, 'one') or sameas(n, 'two')) and (sameas(np, 'five') or sameas(np, 'six'))) + (((1$(arc(np,np)) * nu_nbal(n+3))$(ord(n) <= card(n) - 3))$(ord(np) = 3))$(l(n) and (sameas(np, 'five') or sameas(np, 'four') or sameas(np, 'six'))) + (((1$(arc(np,np)) * nu_nbal(n+5))$(ord(n) <= card(n) - 5))$(ord(np) = 5))$(sameas(n, 'one') and sameas(np, 'six')) + (((1$(arc(np,np)) * nu_nbal(n-5))$(ord(n) > 5))$(ord(np) = 5))$(sameas(n, 'six') and sameas(np, 'one')) - piL_t(n,np))$(arc(n,np)) =E= 0;
