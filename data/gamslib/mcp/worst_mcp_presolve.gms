...
$onMultiR
$include "data/gamslib/raw/worst.gms"
$offMulti

* Transfer NLP duals to MCP multiplier initialization
nu_futval.l(i,t,j) = futval.m(i,t,j);
nu_callval.l(i,t,j) = callval.m(i,t,j);
nu_putval.l(i,t,j) = putval.m(i,t,j);
nu_dd1.l(i,t,j) = dd1.m(i,t,j);
nu_dd2.l(i,t,j) = dd2.m(i,t,j);

* Transfer variable marginals to bound multipliers
piL_f.l(i,t)$(abs(f.l(i,t) - f.lo(i,t)) < 1e-6) = abs(f.m(i,t));
piL_c.l(i,j,t)$(abs(c.l(i,j,t) - c.lo(i,j,t)) < 1e-6) = abs(c.m(i,j,t));
piL_p.l(i,j,t)$(abs(p.l(i,j,t) - p.lo(i,j,t)) < 1e-6) = abs(p.m(i,j,t));
piL_r.l(t)$(abs(r.l(t) - r.lo(t)) < 1e-6) = abs(r.m(t));
piL_q.l(t)$(abs(q.l(t) - q.lo(t)) < 1e-6) = abs(q.m(t));
piU_r.l(t)$(abs(r.l(t) - r.up(t)) < 1e-6) = abs(r.m(t));
piU_q.l(t)$(abs(q.l(t) - q.up(t)) < 1e-6) = abs(q.m(t));

* Reset any NA/UNDF warm-start multiplier levels to 0 (#1322)
nu_futval.l(i,t,j)$(NOT (nu_futval.l(i,t,j) > -inf and nu_futval.l(i,t,j) < inf)) = 0;
nu_callval.l(i,t,j)$(NOT (nu_callval.l(i,t,j) > -inf and nu_callval.l(i,t,j) < inf)) = 0;
nu_putval.l(i,t,j)$(NOT (nu_putval.l(i,t,j) > -inf and nu_putval.l(i,t,j) < inf)) = 0;
nu_dd1.l(i,t,j)$(NOT (nu_dd1.l(i,t,j) > -inf and nu_dd1.l(i,t,j) < inf)) = 0;
nu_dd2.l(i,t,j)$(NOT (nu_dd2.l(i,t,j) > -inf and nu_dd2.l(i,t,j) < inf)) = 0;
piL_f.l(i,t)$(NOT (piL_f.l(i,t) > -inf and piL_f.l(i,t) < inf)) = 0;
piL_c.l(i,j,t)$(NOT (piL_c.l(i,j,t) > -inf and piL_c.l(i,j,t) < inf)) = 0;
piL_p.l(i,j,t)$(NOT (piL_p.l(i,j,t) > -inf and piL_p.l(i,j,t) < inf)) = 0;
piL_r.l(t)$(NOT (piL_r.l(t) > -inf and piL_r.l(t) < inf)) = 0;
piL_q.l(t)$(NOT (piL_q.l(t) > -inf and piL_q.l(t) < inf)) = 0;
piU_r.l(t)$(NOT (piU_r.l(t) > -inf and piU_r.l(t) < inf)) = 0;
piU_q.l(t)$(NOT (piU_q.l(t) > -inf and piU_q.l(t) < inf)) = 0;
