...
Parameters
    a(c,p) /pellets.'pig-iron' -1.58, pellets.sponge -1.38, coke.'pig-iron' -0.63, 'nat-gas'.sponge -0.57, electric.'steel-el' -0.58, scrap.'steel-oh' -0.33, scrap.'steel-el' -0.12, 'pig-iron'.'pig-iron' 1.0, 'pig-iron'.'steel-oh' -0.77, 'pig-iron'.'steel-bof' -0.95, sponge.sponge 1.0, sponge.'steel-oh' -1.09, steel.'steel-oh' 1.0, steel.'steel-el' 1.0, steel.'steel-bof' 1.0, sponge.'pig-iron' 0.0, sponge.'steel-el' 0.0, sponge.'steel-bof' 0.0, steel.'pig-iron' 0.0, steel.sponge 0.0, scrap.'pig-iron' 0.0, scrap.sponge 0.0, scrap.'steel-bof' 0.0, pellets.'steel-oh' 0.0, pellets.'steel-el' 0.0, pellets.'steel-bof' 0.0, coke.sponge 0.0, coke.'steel-oh' 0.0, coke.'steel-el' 0.0, coke.'steel-bof' 0.0, electric.'pig-iron' 0.0, electric.sponge 0.0, electric.'steel-oh' 0.0, electric.'steel-bof' 0.0, 'pig-iron'.sponge 0.0, 'pig-iron'.'steel-el' 0.0, 'nat-gas'.'pig-iron' 0.0, 'nat-gas'.'steel-oh' 0.0, 'nat-gas'.'steel-el' 0.0, 'nat-gas'.'steel-bof' 0.0/
    b(m,p) /'blast-furn'.'pig-iron' 1.0, openhearth.'steel-oh' 1.0, bof.'steel-bof' 1.0, 'direct-red'.sponge 1.0, 'elec-arc'.'steel-el' 1.0, 'direct-red'.'pig-iron' 0.0, 'direct-red'.'steel-oh' 0.0, 'direct-red'.'steel-el' 0.0, 'direct-red'.'steel-bof' 0.0, 'elec-arc'.'pig-iron' 0.0, 'elec-arc'.sponge 0.0, 'elec-arc'.'steel-oh' 0.0, 'elec-arc'.'steel-bof' 0.0, openhearth.'pig-iron' 0.0, openhearth.sponge 0.0, openhearth.'steel-el' 0.0, openhearth.'steel-bof' 0.0, 'blast-furn'.sponge 0.0, 'blast-furn'.'steel-oh' 0.0, 'blast-furn'.'steel-el' 0.0, 'blast-furn'.'steel-bof' 0.0, bof.'pig-iron' 0.0, bof.sponge 0.0, bof.'steel-oh' 0.0, bof.'steel-el' 0.0/
    k(m,i) /'blast-furn'.ahmsa 3.25, 'blast-furn'.fundidora 1.4, 'blast-furn'.sicartsa 1.1, openhearth.ahmsa 1.5, openhearth.fundidora 0.85, bof.ahmsa 2.07, bof.fundidora 1.5, bof.sicartsa 1.3, 'direct-red'.hylsa 0.98, 'direct-red'.hylsap 1.0, 'elec-arc'.hylsa 1.13, 'elec-arc'.hylsap 0.56, 'direct-red'.ahmsa 0.0, 'direct-red'.fundidora 0.0, 'direct-red'.sicartsa 0.0, 'elec-arc'.ahmsa 0.0, 'elec-arc'.fundidora 0.0, 'elec-arc'.sicartsa 0.0, openhearth.sicartsa 0.0, openhearth.hylsa 0.0, openhearth.hylsap 0.0, 'blast-furn'.hylsa 0.0, 'blast-furn'.hylsap 0.0, bof.hylsa 0.0, bof.hylsap 0.0/
    d(c,j)
    ...
    muv(j)
    mue(i)
    prices(c,*) /pellets.domestic 18.7, coke.domestic 52.17, 'nat-gas'.domestic 14.0, electric.domestic 24.0, scrap.domestic 105.0, steel.import 150.0, steel.export 140.0, steel.domestic 0.0, scrap.import 0.0, scrap.export 0.0, pellets.import 0.0, pellets.export 0.0, coke.import 0.0, coke.export 0.0, electric.import 0.0, electric.export 0.0, 'nat-gas'.import 0.0, 'nat-gas'.export 0.0/
    pd(c)
    pv(c)
    pe(c)
;
