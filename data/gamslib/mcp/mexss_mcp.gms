...
Parameters
    ...
    muv(j)
    mue(i)
    prices(c,*) /pellets.domestic 18.7, coke.domestic 52.17, 'nat-gas'.import 14.0, electric.domestic 24.0, scrap.domestic 105.0, steel.import 150.0, steel.export 140.0, pellets.import 0.0, pellets.export 0.0, steel.domestic 0.0, 'nat-gas'.domestic 0.0, 'nat-gas'.export 0.0, electric.import 0.0, electric.export 0.0, scrap.import 0.0, scrap.export 0.0, coke.import 0.0, coke.export 0.0/
    pd(c)
    pv(c)
    pe(c)
;
