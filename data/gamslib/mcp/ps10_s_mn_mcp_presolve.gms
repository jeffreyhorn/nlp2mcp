...
$onMultiR
$include "data/gamslib/raw/ps10_s_mn.gms"
$offMulti

* Transfer NLP duals to MCP multiplier initialization
nu_rev.l(i) = rev.m(i);
lam_pc.l(i) = abs(pc.m(i));
lam_licd.l(i) = abs(licd.m(i));
...
lam_licd.l(i)$(NOT (lam_licd.l(i) > -inf and lam_licd.l(i) < inf)) = 0;
...
comp_licd(i).. w(i) - theta(i) * x(i) - (w(i+1) - theta(i) * x(i+1)) =G= 0;
