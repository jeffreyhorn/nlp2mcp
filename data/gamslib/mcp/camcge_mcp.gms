...
stat_p(i).. x(i) * nu_absorption(i) + sum(j, (-1) * io(i,j) * nu_actp(j)) + sum(j, (-1) * imat(i,j) * nu_pkdef(j)) + cd(i) * nu_cdeq(i) + ((-1) * gd(i)) * nu_gruse + kio(i) * dst(i) * nu_prodinv(i) + (kio(i-1) * dst(i) * nu_prodinv(i-1))$(ord(i) > 1) + (kio(i+6) * dst(i) * nu_prodinv(i+6))$(ord(i) <= card(i) - 6) + (kio(i+3) * dst(i) * nu_prodinv(i+3))$(ord(i) <= card(i) - 3) + (kio(i+4) * dst(i) * nu_prodinv(i+4))$(ord(i) <= card(i) - 4) + (kio(i+5) * dst(i) * nu_prodinv(i+5))$(ord(i) <= card(i) - 5) + (kio(i+7) * dst(i) * nu_prodinv(i+7))$(ord(i) <= card(i) - 7) + (kio(i+2) * dst(i) * nu_prodinv(i+2))$(ord(i) <= card(i) - 2) + (kio(i+9) * dst(i) * nu_prodinv(i+9))$(ord(i) <= card(i) - 9) + (kio(i+8) * dst(i) * nu_prodinv(i+8))$(ord(i) <= card(i) - 8) + (kio(i+1) * dst(i) * nu_prodinv(i+1))$(ord(i) <= card(i) - 1) + (kio(i+10) * dst(i) * nu_prodinv(i+10))$(ord(i) <= card(i) - 10) + (kio(i-6) * dst(i) * nu_prodinv(i-6))$(ord(i) > 6) + (kio(i-7) * dst(i) * nu_prodinv(i-7))$(ord(i) > 7) + (kio(i-3) * dst(i) * nu_prodinv(i-3))$(ord(i) > 3) + (kio(i-2) * dst(i) * nu_prodinv(i-2))$(ord(i) > 2) + (kio(i-4) * dst(i) * nu_prodinv(i-4))$(ord(i) > 4) + (kio(i-5) * dst(i) * nu_prodinv(i-5))$(ord(i) > 5) + (kio(i-8) * dst(i) * nu_prodinv(i-8))$(ord(i) > 8) + (kio(i-9) * dst(i) * nu_prodinv(i-9))$(ord(i) > 9) + (kio(i-10) * dst(i) * nu_prodinv(i-10))$(ord(i) > 10) - piL_p(i) =E= 0;
...
stat_xd(i).. px(i) * nu_sales(i) + nu_activity(i) + sum(lc, (((-1) * (alphl(lc,i) * pva(i))) * nu_profitmax(i,lc))$(wdist(i,lc))) + nu_cet(i)$(it(i)) - nu_xxdsn(i)$(in(i)) + sum(j, (-1) * io(j,i) * nu_inteq(j)) + ((-1) * dstr(i)) * nu_dsteq(i) + ((-1) * pva(i)) * nu_gdp + ((-1) * (itax(i) * px(i))) * nu_indtaxdef - piL_xd(i) =E= 0;
