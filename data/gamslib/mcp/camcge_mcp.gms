...
stat_dk(i).. pk(i) * nu_prodinv(i) + ((-1) * imat(i,i)) * nu_ieq(i) + (((-1) * imat(i,i)) * nu_ieq(i-1))$(ord(i) > 1) + (((-1) * imat(i,i)) * nu_ieq(i+6))$(ord(i) <= card(i) - 6) + (((-1) * imat(i,i)) * nu_ieq(i+3))$(ord(i) <= card(i) - 3) + (((-1) * imat(i,i)) * nu_ieq(i+4))$(ord(i) <= card(i) - 4) + (((-1) * imat(i,i)) * nu_ieq(i+5))$(ord(i) <= card(i) - 5) + (((-1) * imat(i,i)) * nu_ieq(i+7))$(ord(i) <= card(i) - 7) + (((-1) * imat(i,i)) * nu_ieq(i+2))$(ord(i) <= card(i) - 2) + (((-1) * imat(i,i)) * nu_ieq(i+9))$(ord(i) <= card(i) - 9) + (((-1) * imat(i,i)) * nu_ieq(i+8))$(ord(i) <= card(i) - 8) + (((-1) * imat(i,i)) * nu_ieq(i+1))$(ord(i) <= card(i) - 1) + (((-1) * imat(i,i)) * nu_ieq(i+10))$(ord(i) <= card(i) - 10) + (((-1) * imat(i,i)) * nu_ieq(i-6))$(ord(i) > 6) + (((-1) * imat(i,i)) * nu_ieq(i-7))$(ord(i) > 7) + (((-1) * imat(i,i)) * nu_ieq(i-3))$(ord(i) > 3) + (((-1) * imat(i,i)) * nu_ieq(i-2))$(ord(i) > 2) + (((-1) * imat(i,i)) * nu_ieq(i-4))$(ord(i) > 4) + (((-1) * imat(i,i)) * nu_ieq(i-5))$(ord(i) > 5) + (((-1) * imat(i,i)) * nu_ieq(i-8))$(ord(i) > 8) + (((-1) * imat(i,i)) * nu_ieq(i-9))$(ord(i) > 9) + (((-1) * imat(i,i)) * nu_ieq(i-10))$(ord(i) > 10) =E= 0;
...
stat_p(i).. x(i) * nu_absorption(i) + ((-1) * io(i,i)) * nu_actp(i) + (((-1) * io(i,i)) * nu_actp(i-1))$(ord(i) > 1) + (((-1) * io(i,i)) * nu_actp(i+6))$(ord(i) <= card(i) - 6) + (((-1) * io(i,i)) * nu_actp(i+3))$(ord(i) <= card(i) - 3) + (((-1) * io(i,i)) * nu_actp(i+4))$(ord(i) <= card(i) - 4) + (((-1) * io(i,i)) * nu_actp(i+5))$(ord(i) <= card(i) - 5) + (((-1) * io(i,i)) * nu_actp(i+7))$(ord(i) <= card(i) - 7) + (((-1) * io(i,i)) * nu_actp(i+2))$(ord(i) <= card(i) - 2) + (((-1) * io(i,i)) * nu_actp(i+9))$(ord(i) <= card(i) - 9) + (((-1) * io(i,i)) * nu_actp(i+8))$(ord(i) <= card(i) - 8) + (((-1) * io(i,i)) * nu_actp(i+1))$(ord(i) <= card(i) - 1) + (((-1) * io(i,i)) * nu_actp(i+10))$(ord(i) <= card(i) - 10) + (((-1) * io(i,i)) * nu_actp(i-6))$(ord(i) > 6) + (((-1) * io(i,i)) * nu_actp(i-7))$(ord(i) > 7) + (((-1) * io(i,i)) * nu_actp(i-3))$(ord(i) > 3) + (((-1) * io(i,i)) * nu_actp(i-2))$(ord(i) > 2) + (((-1) * io(i,i)) * nu_actp(i-4))$(ord(i) > 4) + (((-1) * io(i,i)) * nu_actp(i-5))$(ord(i) > 5) + (((-1) * io(i,i)) * nu_actp(i-8))$(ord(i) > 8) + (((-1) * io(i,i)) * nu_actp(i-9))$(ord(i) > 9) + (((-1) * io(i,i)) * nu_actp(i-10))$(ord(i) > 10) + ((-1) * imat(i,i)) * nu_pkdef(i) + (((-1) * imat(i,i)) * nu_pkdef(i-1))$(ord(i) > 1) + (((-1) * imat(i,i)) * nu_pkdef(i+6))$(ord(i) <= card(i) - 6) + (((-1) * imat(i,i)) * nu_pkdef(i+3))$(ord(i) <= card(i) - 3) + (((-1) * imat(i,i)) * nu_pkdef(i+4))$(ord(i) <= card(i) - 4) + (((-1) * imat(i,i)) * nu_pkdef(i+5))$(ord(i) <= card(i) - 5) + (((-1) * imat(i,i)) * nu_pkdef(i+7))$(ord(i) <= card(i) - 7) + (((-1) * imat(i,i)) * nu_pkdef(i+2))$(ord(i) <= card(i) - 2) + (((-1) * imat(i,i)) * nu_pkdef(i+9))$(ord(i) <= card(i) - 9) + (((-1) * imat(i,i)) * nu_pkdef(i+8))$(ord(i) <= card(i) - 8) + (((-1) * imat(i,i)) * nu_pkdef(i+1))$(ord(i) <= card(i) - 1) + (((-1) * imat(i,i)) * nu_pkdef(i+10))$(ord(i) <= card(i) - 10) + (((-1) * imat(i,i)) * nu_pkdef(i-6))$(ord(i) > 6) + (((-1) * imat(i,i)) * nu_pkdef(i-7))$(ord(i) > 7) + (((-1) * imat(i,i)) * nu_pkdef(i-3))$(ord(i) > 3) + (((-1) * imat(i,i)) * nu_pkdef(i-2))$(ord(i) > 2) + (((-1) * imat(i,i)) * nu_pkdef(i-4))$(ord(i) > 4) + (((-1) * imat(i,i)) * nu_pkdef(i-5))$(ord(i) > 5) + (((-1) * imat(i,i)) * nu_pkdef(i-8))$(ord(i) > 8) + (((-1) * imat(i,i)) * nu_pkdef(i-9))$(ord(i) > 9) + (((-1) * imat(i,i)) * nu_pkdef(i-10))$(ord(i) > 10) + cd(i) * nu_cdeq(i) + ((-1) * gd(i)) * nu_gruse + kio(i) * dst(i) * nu_prodinv(i) + (kio(i) * dst(i) * nu_prodinv(i-1))$(ord(i) > 1) + (kio(i) * dst(i) * nu_prodinv(i+6))$(ord(i) <= card(i) - 6) + (kio(i) * dst(i) * nu_prodinv(i+3))$(ord(i) <= card(i) - 3) + (kio(i) * dst(i) * nu_prodinv(i+4))$(ord(i) <= card(i) - 4) + (kio(i) * dst(i) * nu_prodinv(i+5))$(ord(i) <= card(i) - 5) + (kio(i) * dst(i) * nu_prodinv(i+7))$(ord(i) <= card(i) - 7) + (kio(i) * dst(i) * nu_prodinv(i+2))$(ord(i) <= card(i) - 2) + (kio(i) * dst(i) * nu_prodinv(i+9))$(ord(i) <= card(i) - 9) + (kio(i) * dst(i) * nu_prodinv(i+8))$(ord(i) <= card(i) - 8) + (kio(i) * dst(i) * nu_prodinv(i+1))$(ord(i) <= card(i) - 1) + (kio(i) * dst(i) * nu_prodinv(i+10))$(ord(i) <= card(i) - 10) + (kio(i) * dst(i) * nu_prodinv(i-6))$(ord(i) > 6) + (kio(i) * dst(i) * nu_prodinv(i-7))$(ord(i) > 7) + (kio(i) * dst(i) * nu_prodinv(i-3))$(ord(i) > 3) + (kio(i) * dst(i) * nu_prodinv(i-2))$(ord(i) > 2) + (kio(i) * dst(i) * nu_prodinv(i-4))$(ord(i) > 4) + (kio(i) * dst(i) * nu_prodinv(i-5))$(ord(i) > 5) + (kio(i) * dst(i) * nu_prodinv(i-8))$(ord(i) > 8) + (kio(i) * dst(i) * nu_prodinv(i-9))$(ord(i) > 9) + (kio(i) * dst(i) * nu_prodinv(i-10))$(ord(i) > 10) - piL_p(i) =E= 0;
