...
Parameters
    ...
    freq(c,en)
    sreq(s,en,f)
    cxfert(ca) /azolla 1.3, 'rapes-c' 200/
...
stat_xfert(ca).. (sum(cf__, ((-1) * cxfert(cf__)) * nu_cdef)$(cf(ca)) + sum(cf__, crec(ca,cf__) * lam_mb(ca)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca-2))$(ord(ca) > 2)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca+11))$(ord(ca) <= card(ca) - 11)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca+13))$(ord(ca) <= card(ca) - 13)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca-7))$(ord(ca) > 7)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca+10))$(ord(ca) <= card(ca) - 10)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca+12))$(ord(ca) <= card(ca) - 12)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca+8))$(ord(ca) <= card(ca) - 8)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca-3))$(ord(ca) > 3)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca+15))$(ord(ca) <= card(ca) - 15)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca+17))$(ord(ca) <= card(ca) - 17)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca+5))$(ord(ca) <= card(ca) - 5)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca+7))$(ord(ca) <= card(ca) - 7)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca+21))$(ord(ca) <= card(ca) - 21)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca+1))$(ord(ca) <= card(ca) - 1)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca+3))$(ord(ca) <= card(ca) - 3)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca-1))$(ord(ca) > 1)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca-4))$(ord(ca) > 4)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca+14))$(ord(ca) <= card(ca) - 14)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca+4))$(ord(ca) <= card(ca) - 4)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca+18))$(ord(ca) <= card(ca) - 18)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca+9))$(ord(ca) <= card(ca) - 9)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca+6))$(ord(ca) <= card(ca) - 6)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca-6))$(ord(ca) > 6)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca+2))$(ord(ca) <= card(ca) - 2)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca+19))$(ord(ca) <= card(ca) - 19)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca+16))$(ord(ca) <= card(ca) - 16)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca+20))$(ord(ca) <= card(ca) - 20)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca-5))$(ord(ca) > 5)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca+23))$(ord(ca) <= card(ca) - 23)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca+22))$(ord(ca) <= card(ca) - 22)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca-11))$(ord(ca) > 11)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca-13))$(ord(ca) > 13)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca-18))$(ord(ca) > 18)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca-14))$(ord(ca) > 14)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca-10))$(ord(ca) > 10)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca-8))$(ord(ca) > 8)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca-12))$(ord(ca) > 12)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca-15))$(ord(ca) > 15)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca-17))$(ord(ca) > 17)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca-9))$(ord(ca) > 9)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca-16))$(ord(ca) > 16)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca-19))$(ord(ca) > 19)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca+25))$(ord(ca) <= card(ca) - 25)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca+24))$(ord(ca) <= card(ca) - 24)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca-21))$(ord(ca) > 21)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca-20))$(ord(ca) > 20)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca-25))$(ord(ca) > 25)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca-22))$(ord(ca) > 22)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca-24))$(ord(ca) > 24)) + sum(cf__, (crec(ca,cf__) * lam_mb(ca-23))$(ord(ca) > 23)) + sum(cf__, sum(en, ((-1) * (0.01 * enc(cf__,en))) * lam_fert(en))) - piL_xfert(ca))$(cf(ca)) =E= 0;
stat_xpig(p).. ((-1) * cxpig(p)) * nu_cdef + sum(ca, ((-1) * pigio(ca,p)) * lam_mb(ca)) - piL_xpig(p) =E= 0;
stat_xupland(ca).. (((-1) * yieldu(ca)$(cu(ca))) * lam_mb(ca) + sum(cu__, sum(en, 0.001 * nup(cu__,en) * lam_fert(en))) + lam_landu$(cu(ca)) - piL_xupland(ca))$(cu(ca)) =E= 0;
