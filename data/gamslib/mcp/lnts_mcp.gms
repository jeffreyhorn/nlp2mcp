...
stat_y(c,h).. (((-1) * nu_pos_eqn(c,h)) + nu_pos_eqn(c,h-1)$(ord(h) > 1) + (((-1) * (0.5 * step)) * nu_pos_eqn(c-2,h))$(ord(c) > 2) + (((-1) * (0.5 * step)) * nu_pos_eqn(c-2,h-1))$(ord(c) > 2 and ord(h) > 1) + nu_y_fx_y1_h0$(sameas(c, 'y1') and sameas(h, 'h0')) + nu_y_fx_y2_h0$(sameas(c, 'y2') and sameas(h, 'h0')) + nu_y_fx_y2_h50$(sameas(c, 'y2') and sameas(h, 'h50')) - nu_velo1_eqn(h) + (nu_velo1_eqn(h-1)$(ord(h) > 1))$(ord(c) = 1) + nu_y_fx_y3_h0$(sameas(c, 'y3') and sameas(h, 'h0')) + nu_y_fx_y3_h50$(sameas(c, 'y3') and sameas(h, 'h50')) - nu_velo2_eqn(h) + (nu_velo2_eqn(h-1)$(ord(h) > 1))$(ord(c) = 1) + nu_y_fx_y4_h0$(sameas(c, 'y4') and sameas(h, 'h0')) + nu_y_fx_y4_h50$(sameas(c, 'y4') and sameas(h, 'h50')))$(ord(c) <= card(c) - 2 and ord(h) <= card(h) - 1 or ord(h) > 1 or ord(c) > 2 or ord(c) > 2 and ord(h) > 1 or sameas(c, 'y1') and sameas(h, 'h0') or sameas(c, 'y2') and sameas(h, 'h0') or sameas(c, 'y2') and sameas(h, 'h50') or ord(h) <= card(h) - 1 or ord(c) = 1 or sameas(c, 'y3') and sameas(h, 'h0') or sameas(c, 'y3') and sameas(h, 'h50') or sameas(c, 'y4') and sameas(h, 'h0') or sameas(c, 'y4') and sameas(h, 'h50')) =E= 0;
...
y.fx(c,h)$(not (ord(c) <= card(c) - 2 and ord(h) <= card(h) - 1 or ord(h) > 1 or ord(c) > 2 or ord(c) > 2 and ord(h) > 1 or sameas(c, 'y1') and sameas(h, 'h0') or sameas(c, 'y2') and sameas(h, 'h0') or sameas(c, 'y2') and sameas(h, 'h50') or ord(h) <= card(h) - 1 or ord(c) = 1 or sameas(c, 'y3') and sameas(h, 'h0') or sameas(c, 'y3') and sameas(h, 'h50') or sameas(c, 'y4') and sameas(h, 'h0') or sameas(c, 'y4') and sameas(h, 'h50'))) = 0;
