...
Parameters
    pwbound(s,b) /'stage-1'.lower 12, 'stage-1'.upper 16, 'stage-2'.lower 10, 'stage-2'.upper 12, 'stage-3'.upper 7, 'stage-3'.lower 9/
...
stat_iweight(s).. (-1032.935643) * pweight(s) ** (-0.9904) * thrust(s) ** 0.38745 * ms(s) ** 2.4242 * aweight(s) ** 1.2781 * iweight(s) ** (-1.1959) + iwf(s) * nu_diweight(s) + ((-1) * 1$(ge(s,s))) * nu_dweight(s) + (((-1) * 1$(ge(s,s))) * nu_dweight(s+1))$(ord(s) <= card(s) - 1) + (((-1) * 1$(ge(s,s))) * nu_dweight(s+2))$(ord(s) <= card(s) - 2) + (((-1) * 1$(ge(s,s))) * nu_dweight(s-1))$(ord(s) > 1) + (((-1) * 1$(ge(s,s))) * nu_dweight(s-2))$(ord(s) > 2) + sum(b, pwbound(s,b) * lam_pwlower(s)) + sum(b, ((-1) * pwbound(s,b)) * lam_pwupper(s)) - piL_iweight(s) =E= 0;
