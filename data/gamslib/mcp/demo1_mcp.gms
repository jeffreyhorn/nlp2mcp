...
stat_flab(t).. ((-1) * nu_flabor(t)) - lam_laborbal(t) =E= 0;
stat_fout(t).. ((-1) * nu_flabor(t)) + ((-1) * owage) * nu_aout =E= 0;
...
stat_xcrop(c).. ((-1) * (price(c) * yield(c))) * nu_arev + ((-1) * miscost(c)) * nu_acost + sum(t, landreq(t,c) * lam_landbal(t)) + sum(t, laborreq(t,c) * lam_laborbal(t)) =E= 0;
