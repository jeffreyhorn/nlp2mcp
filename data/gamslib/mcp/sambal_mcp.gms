...
Parameters
    xb(i,j) /lab.h1 15, lab.h2 3, lab.p1 130, lab.p2 80, h1.lab na, h2.lab na, p1.h1 15, p1.h2 130, p1.p2 20, p2.h1 25, p2.h2 40, p2.p1 55, h1.h1 0, h1.h2 0, h1.p1 0, h1.p2 0, p1.lab 0, p1.p1 0, p2.lab 0, p2.p2 0, lab.lab 0, h2.h1 0, h2.h2 0, h2.p1 0, h2.p2 0/
...
stat_x(i,j).. xb(i,j) * xw(i,j) * 2 * (xb(i,j) - x(i,j)) * (-1) / xb(i,j) ** 2 * xw(i,j) + ((-1) * xb(i,j)) * nu_cbal(j) =E= 0;
