...
Parameters
    ...
    demdat(c,*) /wheat.'ref-p' 100, wheat.'ref-q' 2700, wheat.elas -0.8, wheat.'imp-p' 140, beans.'ref-p' 200, beans.'ref-q' 900, beans.elas -0.4, beans.'imp-p' 270, onions.'ref-p' 125, onions.'ref-q' 700, onions.elas -1, onions.'exp-p' 40, onions.'imp-p' inf, cotton.'ref-p' 350, cotton.'ref-q' 2100, cotton.elas -1, cotton.'exp-p' 300, cotton.'imp-p' inf, maize.'ref-p' 70, maize.'ref-q' 3800, maize.elas -0.5, maize.'imp-p' 85, tomato.'ref-p' 120, tomato.'ref-q' 500, tomato.elas -1.2, tomato.'exp-p' 60, tomato.'imp-p' inf/
...
stat_xcrop(c).. ((-1) * miscost(c)) * nu_amisc + ((-1) * yield(c)) * nu_proc(c) + sum(t, a(t,c) * lam_landbal(t)) + sum(t, lc(t,c) * lam_laborbal(t)) + sum(s, 1$(sc(c,s)) * lam_plow(c)) + (((-1) * yield(c)) * lam_lclover)$(sameas(c, 'clover')) + (((-1) * straw) * lam_lstraw)$(sameas(c, 'wheat')) - piL_xcrop(c) =E= 0;
