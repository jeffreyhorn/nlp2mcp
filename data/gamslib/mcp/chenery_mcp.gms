...
stat_e(i).. ((alp(i) * nu_dh(i))$(t(i)) + 1$(t(i)) * lam_mb(i) + sum(t__$(sameas(t__, i)), ((-1) * h(t__)) * lam_tb)$(t(i)) - piL_e(i) + piU_e(i))$(t(i)) =E= 0;
...
stat_m(i).. ((((-1) * xsi(i)) * nu_dg(i))$(t(i)) + (-1)$(t(i)) * lam_mb(i) + sum(t__$(sameas(t__, i)), g(t__) * lam_tb)$(t(i)) - piL_m(i) + piU_m(i))$(t(i)) =E= 0;
