...
stat_h(m,t).. sum(tp, ((-1) * (sgm * nu(m) * 1$(avl(t,tp)))) * nu_ainvc(t)) + sum(tp, ((((-1) * (sgm * nu(m) * 1$(avl(t,tp)))) * nu_ainvc(t+1))$(ord(t) <= card(t) - 1))$(ord(m) = 1)) + sum(tp, ((((-1) * (sgm * nu(m) * 1$(avl(t,tp)))) * nu_ainvc(t+2))$(ord(t) <= card(t) - 2))$(ord(m) = 2)) + sum(tp, ((((-1) * (sgm * nu(m) * 1$(avl(t,tp)))) * nu_ainvc(t+3))$(ord(t) <= card(t) - 3))$(ord(m) = 3)) + sum(tp, ((((-1) * (sgm * nu(m) * 1$(avl(t,tp)))) * nu_ainvc(t+4))$(ord(t) <= card(t) - 4))$(ord(m) = 4)) + sum(tp, ((((-1) * (sgm * nu(m) * 1$(avl(t,tp)))) * nu_ainvc(t+5))$(ord(t) <= card(t) - 5))$(ord(m) = 5)) + sum(tp, ((((-1) * (sgm * nu(m) * 1$(avl(t,tp)))) * nu_ainvc(t+6))$(ord(t) <= card(t) - 6))$(ord(m) = 6)) + sum(tp, ((((-1) * (sgm * nu(m) * 1$(avl(t,tp)))) * nu_ainvc(t+7))$(ord(t) <= card(t) - 7))$(ord(m) = 7)) + sum(tp, ((((-1) * (sgm * nu(m) * 1$(avl(t,tp)))) * nu_ainvc(t+8))$(ord(t) <= card(t) - 8))$(ord(m) = 8)) + sum(tp, ((((-1) * (sgm * nu(m) * 1$(avl(t,tp)))) * nu_ainvc(t-1))$(ord(t) > 1))$(ord(m) = 1)) + sum(tp, ((((-1) * (sgm * nu(m) * 1$(avl(t,tp)))) * nu_ainvc(t-2))$(ord(t) > 2))$(ord(m) = 2)) + sum(tp, ((((-1) * (sgm * nu(m) * 1$(avl(t,tp)))) * nu_ainvc(t-3))$(ord(t) > 3))$(ord(m) = 3)) + sum(tp, ((((-1) * (sgm * nu(m) * 1$(avl(t,tp)))) * nu_ainvc(t-4))$(ord(t) > 4))$(ord(m) = 4)) + sum(tp, ((((-1) * (sgm * nu(m) * 1$(avl(t,tp)))) * nu_ainvc(t-5))$(ord(t) > 5))$(ord(m) = 5)) + sum(tp, ((((-1) * (sgm * nu(m) * 1$(avl(t,tp)))) * nu_ainvc(t-6))$(ord(t) > 6))$(ord(m) = 6)) + sum(tp, ((((-1) * (sgm * nu(m) * 1$(avl(t,tp)))) * nu_ainvc(t-7))$(ord(t) > 7))$(ord(m) = 7)) + sum(tp, ((((-1) * (sgm * nu(m) * 1$(avl(t,tp)))) * nu_ainvc(t-8))$(ord(t) > 8))$(ord(m) = 8)) + sum(tp, ((-1) * 1$(avl(t,tp))) * lam_cap(m,t)) + sum(tp, (((-1) * 1$(avl(tp+1,tp))) * lam_cap(m,t+1))$(ord(t) <= card(t) - 1)) + sum(tp, (((-1) * 1$(avl(tp+2,tp))) * lam_cap(m,t+2))$(ord(t) <= card(t) - 2)) + sum(tp, (((-1) * 1$(avl(tp+3,tp))) * lam_cap(m,t+3))$(ord(t) <= card(t) - 3)) + sum(tp, (((-1) * 1$(avl(tp+4,tp))) * lam_cap(m,t+4))$(ord(t) <= card(t) - 4)) + sum(tp, (((-1) * 1$(avl(tp+5,tp))) * lam_cap(m,t+5))$(ord(t) <= card(t) - 5)) + sum(tp, (((-1) * 1$(avl(tp+6,tp))) * lam_cap(m,t+6))$(ord(t) <= card(t) - 6)) + sum(tp, (((-1) * 1$(avl(tp+7,tp))) * lam_cap(m,t+7))$(ord(t) <= card(t) - 7)) + sum(tp, (((-1) * 1$(avl(tp+8,tp))) * lam_cap(m,t+8))$(ord(t) <= card(t) - 8)) + sum(tp, (((-1) * 1$(avl(tp-1,tp))) * lam_cap(m,t-1))$(ord(t) > 1)) + sum(tp, (((-1) * 1$(avl(tp-2,tp))) * lam_cap(m,t-2))$(ord(t) > 2)) + sum(tp, (((-1) * 1$(avl(tp-3,tp))) * lam_cap(m,t-3))$(ord(t) > 3)) + sum(tp, (((-1) * 1$(avl(tp-4,tp))) * lam_cap(m,t-4))$(ord(t) > 4)) + sum(tp, (((-1) * 1$(avl(tp-5,tp))) * lam_cap(m,t-5))$(ord(t) > 5)) + sum(tp, (((-1) * 1$(avl(tp-6,tp))) * lam_cap(m,t-6))$(ord(t) > 6)) + sum(tp, (((-1) * 1$(avl(tp-7,tp))) * lam_cap(m,t-7))$(ord(t) > 7)) + sum(tp, (((-1) * 1$(avl(tp-8,tp))) * lam_cap(m,t-8))$(ord(t) > 8)) - piL_h(m,t) =E= 0;
...
stat_r(c,te).. (nu_lbal(c,te) + ((-1) * muc) * nu_acutc(te) + ((((-1) * muc) * nu_acutc(te-9))$(ord(te) > 9))$(ord(c) = 9) + ((((-1) * muc) * nu_acutc(te-10))$(ord(te) > 10))$(ord(c) = 10) + ((((-1) * muc) * nu_acutc(te-11))$(ord(te) > 11))$(ord(c) = 11) + ((-1) * 1$(cl(c))) * lam_bal(c,te) - lam_sy2(c,te) + lam_sy2(c,te+1)$(ord(te) <= card(te) - 1) - piL_r(c,te))$(cl(c)) =E= 0;
stat_v(s,k,t,te).. sum(cl, ((-1) * yv(t,t,s,cl,k)) * nu_lbal(cl,te)) + 1$(vpos(t,te)) * lam_pfs(s,k,t) - piL_v(s,k,t,te) =E= 0;
stat_w(s,k,u,te).. sum(cl, ((-1) * yw(te,u,s,cl)) * nu_lbal(cl,te)) + sum(t, 10 * 1$(wpos(u,t)) * lam_efs(s,k,u)) + ((-1) * 1$(wpos(u,te))) * lam_pfs(s,k,te) - piL_w(s,k,u,te) =E= 0;
stat_x(c,t).. (sum(cf__, ((-1) * pd(cf__)) * nu_asales(t)) + 1$(cf(c)) * lam_bal(c,t) - piL_x(c,t))$(cf(c)) =E= 0;
