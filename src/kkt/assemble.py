...
def assemble_kkt_system(
    ...
    multipliers_bounds_lo = _create_bound_lo_multipliers(partition.bounds_lo, model_ir)
    multipliers_bounds_up = _create_bound_up_multipliers(partition.bounds_up, model_ir)
