...
nlp2mcp-report --type status --output docs/testing/GAMSLIB_STATUS.md
```
...
**No migration needed.** v1.1.0 is fully backward-compatible with v0.7.0.
...
1. **Use the new reporting infrastructure:**
   ...
   nlp2mcp-report --type status --output status.md
   ```
