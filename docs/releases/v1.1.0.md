...
| Full Pipeline | 3.1% (5/160) | 6.9% (11/160) | +6 models |

**Note:** The solve rate percentage decreased because many more models now reach the solve stage (42 vs 21). The absolute solve count remains at 11 models. Full Pipeline now counts all 11 solve-successful models.
