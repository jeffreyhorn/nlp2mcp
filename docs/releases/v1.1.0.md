...
The following 11 models successfully solve with PATH after translation (52.4% of translated models):
- apl1p, blend, himmel11, hs62, mathopt1, mathopt2, mhw4d, mhw4dx, prodmix, rbrock, trig

**Note:** "Full Pipeline Success" (5 models, 3.1%) refers to models that also pass objective value comparison. "Solve Success" (11 models) means PATH returns a solution without checking objective accuracy.
