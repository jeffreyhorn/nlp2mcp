...
**Remaining long-term work:** Multi-solve warm-start infrastructure (solve original NLP first, use solution to initialize MCP). Deferred — 6h+ architectural change.
