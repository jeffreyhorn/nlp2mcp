...
**Status:** PARTIALLY DONE (Sprint 27 Day 7) — translate-time short-circuit LANDED; the runtime-guard equation-body re-emit + `J_gᵀ·lam` cross-terms are **REPLAN'd → Sprint 31** as a dedicated builder-pipeline-aware symbolic-emit workstream (Sprint 30 Day 9: re-confirmed the atomic symbolic-emit is the Sprint-26-Day-4-failed architecture — intractable in a ~7h day; see the Day-9 block below). _(was: REPLAN'd → Sprint 30 at Sprint 29 Day 9; DEFERRED → Sprint 29; re-deferred at Sprint 28 Day 11.)_
