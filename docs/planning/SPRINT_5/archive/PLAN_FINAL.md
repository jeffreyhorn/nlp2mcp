# Sprint 5 Plan (FINAL): Hardening, Packaging, and Documentation
...
**Finalized:** November 6, 2025

---

## Revision Summary

This FINAL plan incorporates all previous revisions plus three final fixes:

**Previous Revisions (PLAN_REVISED.md):**

**Finding 1:** Days 1, 2, 4, 5, 7, 8, and 10 were weaving Known Unknown note-taking into core execution tasks and missing the required `Follow-On Research Items` section.
- **Fixed:** Added explicit `Follow-On Research Items` sections to all affected days
- **Fixed:** Relocated Known Unknown summaries to research sections, keeping execution tasks clean

**Finding 2:** Days 5 and 6 labeled Unknowns 3.1 and 3.2 as ✅ COMPLETE while the source research file still lists them as 🔍 INCOMPLETE.
- **Fixed:** Corrected Unknown 3.1 status to reflect Task 8 completion (performance baselines established)
- **Fixed:** Corrected Unknown 3.2 status to 🔍 INCOMPLETE (research done, tests not yet implemented)
- **Fixed:** Updated KNOWN_UNKNOWNS.md status tracking to match plan

**Finding 3:** The packaging automation scope on Days 7-8 omits automated version bumping, changelog generation, and the explicit requirement to update `CHANGELOG.md`.
- **Fixed:** Added Task 8.2 for automated version bumping
- **Fixed:** Added Task 8.3 for automated changelog generation
- **Fixed:** Added explicit CHANGELOG.md update requirement to Day 8 deliverables

**Finding 4:** The documentation plan (Day 9) covers tutorial, FAQ, and troubleshooting updates but leaves out the API reference/site deliverable that Sprint 5 committed to producing.
- **Fixed:** Added Task 9.5 for API documentation (Sphinx-based)
- **Fixed:** Added API reference site to Day 9 deliverables
- **Fixed:** Expanded Day 9 from 8 hours to account for additional API docs work (adjusting Day 10 buffer accordingly)

**Final Fixes (PLAN_FINAL.md):**

**Fix 1:** Restored Unknown cross-references in task bullets for all tasks that depend on unknowns across all days
- **Added:** Brief cross-references in task bullets using format: `**Related Unknown:** Unknown X.Y (STATUS) - Brief finding`
- **Note:** Detailed summaries remain in Follow-On Research Items sections

**Fix 2:** Added Follow-On Research Items section to Day 6 (previously missing)
- **Added:** Unknown 3.2 to Day 6 Follow-On Research section after Integration Risks

**Fix 3:** Updated this revision summary to reflect FINAL status
- **Added:** Note about KNOWN_UNKNOWNS.md updates for Unknowns 3.1 and 5.1
- **Added:** Note about restoring Unknown cross-references in task bullets
- **Added:** Note about adding Day 6 Follow-On Research section
...
5. **User Documentation** - Tutorial, FAQ, troubleshooting guides, and API reference
...
8. ✅ Release automation complete
   - GitHub Actions for PyPI
   - Automated version bumping
   - Automated changelog generation
   - CHANGELOG.md updated

9. ✅ API documentation published
...
- **Related Unknowns:**
  - Unknown 1.2 (🔍 INCOMPLETE): How to detect if min/max defines objective variable? - Need to analyze ModelIR.objective_equ to find which equation defines objvar
  - Unknown 1.4 (🔍 INCOMPLETE): What KKT assembly changes needed? - Stationarity equations must include multipliers for ALL equality constraints
...
- **Related Unknown:** Unknown 1.2 (🔍 INCOMPLETE) - Need to analyze ModelIR.objective_equ to find which equation defines objvar
...
- **Related Unknown:** Unknown 1.4 (🔍 INCOMPLETE) - Stationarity equations must include multipliers for ALL equality constraints
...
- **Priority:** High
- **Status:** 🔍 INCOMPLETE
- **Summary:** Need to analyze ModelIR.objective_equ to find which equation defines objvar. Parser already identifies objective_equ, check if it contains min/max operations.
- **Research Needed:** Task 1.2 will implement detection algorithm
- **Deadline:** End of Day 1

**Unknown 1.4:** What KKT assembly changes are needed?
- **Priority:** Critical
- **Status:** 🔍 INCOMPLETE
- **Summary:** Stationarity equations must include multipliers for ALL equality constraints, including auxiliary ones from min/max reformulation. Loop over all normalized equations (not just original), add Jacobian terms to stationarity.
- **Research Needed:** Tasks 1.5 and 2.1 will implement and test assembly changes
...
- **Related Unknown:** Unknown 1.5 (🔍 INCOMPLETE) - PATH solver options may need tuning, default options usually sufficient
...
**Unknown 1.5:** Should PATH solver options be tuned?
- **Priority:** Medium
- **Status:** 🔍 INCOMPLETE
- **Summary:** PATH has many options (presolve, crash, lemke_start, etc.). Default options usually sufficient, may need `lemke_start=advanced` for difficult problems.
- **Research Needed:** Task 2.3 tests with default options, tunes if needed
- **Deadline:** End of Day 2
...
- **Related Unknown:** Unknown 2.1 (🔍 INCOMPLETE) - Why do bounds_nlp and nonlinear_mix fail with Model Status 5? - May indicate modeling issues
...
- **Related Unknowns:**
  - Unknown 2.2 (🔍 INCOMPLETE): Which PATH solver options should be documented? - Key options: presolve, crash, lemke_start, convergence_tolerance
  - Unknown 2.3 (🔍 INCOMPLETE): How to interpret PATH solution quality? - Model Status 1=optimal, 2=locally optimal (both good)
...
- **Priority:** High
- **Status:** 🔍 INCOMPLETE
- **Summary:** Model Status 5 = locally infeasible, meaning KKT system has no solution at starting point. May indicate modeling issues, needs investigation.
- **Research Needed:** Task 3.2 will investigate all Model Status 5 failures
- **Deadline:** End of Day 3

**Unknown 2.2:** Which PATH solver options should be documented?
- **Priority:** Medium
- **Status:** 🔍 INCOMPLETE
- **Summary:** Key options include `presolve`, `crash`, `lemke_start`, `convergence_tolerance`. Need to document when to use each.
- **Research Needed:** Task 3.3 will document all relevant options
- **Deadline:** End of Day 3

**Unknown 2.3:** How to interpret PATH solution quality?
- **Priority:** Medium
- **Status:** 🔍 INCOMPLETE
- **Summary:** Model Status 1=optimal, 2=locally optimal (both good), 4=infeasible, 5=locally infeasible. Residual < 1e-6 is excellent, < 1e-4 is good.
- **Research Needed:** Task 3.3 will document interpretation guide
- **Deadline:** End of Day 3

**Unknown 2.4:** Should PATH validation be in CI/CD?
- **Priority:** Low
- **Status:** 🔍 INCOMPLETE
- **Summary:** GitHub Actions with GAMS licensing may be difficult. Evaluate feasibility.
- **Research Needed:** Defer to Sprint 6 planning (process decision, not critical)
...
- **Related Unknown:** Unknown 3.4 (🔍 INCOMPLETE) - How to handle NaN/Inf? - Detect in evaluator, provide clear error with source location
...
- **Related Unknown:** Unknown 3.5 (🔍 INCOMPLETE) - Should we add model validation pass? - Yes, catch common errors early
...
**Unknown 3.4:** How should we handle NaN and Inf values?
- **Priority:** Medium
- **Status:** 🔍 INCOMPLETE
- **Summary:** Should detect in evaluator, provide clear error with source location. Check after each operation in AD, raise NumericalError with context.
- **Research Needed:** Task 4.1 will implement detection and error handling
- **Deadline:** End of Day 4

**Unknown 3.5:** Should we add a model validation pass?
- **Priority:** High
- **Status:** 🔍 INCOMPLETE
- **Summary:** Yes, catch common errors early (undefined vars, circular deps, type mismatches). Add validation pass before KKT assembly.
- **Research Needed:** Task 4.2 will implement validation pass
- **Deadline:** End of Day 4
...
- **Related Unknown:** Unknown 3.3 (🔍 INCOMPLETE) - Memory optimization techniques? - Use sparse matrices, avoid full Jacobian materialization
...
- Set performance targets (from Task 8 Unknown 3.1 research):
  - 250 vars: < 10s
  - 500 vars: < 30s
  - 1K vars: < 90s (baseline from Task 8: 45.9s ✅)
...
**Unknown 3.3:** Which memory optimization techniques to use?
- **Priority:** Medium
- **Status:** 🔍 INCOMPLETE
- **Summary:** Use sparse matrices (scipy.sparse), avoid full Jacobian materialization, stream emission. Current approach uses sparse AD, should be memory-efficient.
- **Research Needed:** Task 5.3 will profile and optimize if memory exceeds limits
...
- **Related Unknown:** Unknown 3.2 (🔍 INCOMPLETE) - Edge cases research complete, tests not yet implemented
- Implement edge cases from Unknown 3.2 research (completed in prep phase):
...
**Unknown 3.2:** What edge cases should be tested?
- **Priority:** High
- **Status:** 🔍 INCOMPLETE (research complete, tests not yet implemented)
- **Summary:** Edge cases identified: extreme bounds (x.lo=-1e20), degenerate constraints (0=0), all-zero Jacobians (constant equations), circular references (x=y, y=x), empty sets (i={}). Each should either convert successfully or fail with clear error.
- **Research Needed:** Task 6.1 will implement test suite based on completed research
...
- **Related Unknown:** Unknown 4.1 (🔍 INCOMPLETE) - setuptools vs hatch vs flit? - Use hatch, modern and PEP 517 compliant
- Evaluate options:
...
- **Related Unknown:** Unknown 4.2 (🔍 INCOMPLETE) - What PyPI metadata is required? - name, version, description, authors, license, classifiers
...
- **Related Unknown:** Unknown 4.3 (🔍 INCOMPLETE) - How to test multi-platform? - Use tox locally, GitHub Actions for OS matrix
...
**Unknown 4.1:** setuptools vs hatch vs flit?
- **Priority:** Medium
- **Status:** 🔍 INCOMPLETE
- **Summary:** Use `hatch` - modern, PEP 517 compliant, good dev workflow. Hatch recommended for new projects, cleaner than setuptools.
- **Research Needed:** Task 7.1 will evaluate and make decision
- **Deadline:** End of Day 7

**Unknown 4.2:** What PyPI metadata is required?
- **Priority:** Medium
- **Status:** 🔍 INCOMPLETE
- **Summary:** name, version, description, authors, license, classifiers, dependencies. Follow PEP 621, add keywords for discoverability.
- **Research Needed:** Task 7.2 will configure all metadata
- **Deadline:** End of Day 7

**Unknown 4.3:** How to test multi-platform packages?
- **Priority:** Medium
- **Status:** 🔍 INCOMPLETE
- **Summary:** Use `tox` with different Python versions locally, GitHub Actions for OS matrix. Test Python 3.10, 3.11, 3.12 locally, defer full CI matrix to Day 8.
- **Research Needed:** Task 7.6 will test locally, Day 8 will add CI matrix
- **Deadline:** End of Day 7
...
- **Related Unknown:** Unknown 4.4 (🔍 INCOMPLETE) - Version numbering for 1.0.0? - Start at 0.4.0, increment to 1.0.0 when production-ready
...
**Task 8.2: Automated Version Bumping** (1.5 hours)
- Create script for version bumping: `scripts/bump_version.py`
- Update version in:
  - `pyproject.toml`
  - `src/__init__.py`
...
- Acceptance: Version bumping automated and tested

**Task 8.3: Automated Changelog Generation** (1.5 hours)
- Create script for changelog generation: `scripts/generate_changelog.py`
- Parse git commits since last release
- Group by category (Features, Fixes, Breaking Changes)
- Follow Keep a Changelog format
- Update CHANGELOG.md automatically
- Add to GitHub Actions workflow
- Acceptance: Changelog generation automated and tested

**Task 8.4: GitHub Actions Workflow** (1.5 hours)
...
**Task 8.6: Test Installation from TestPyPI** (0.5 hours)
...
**Task 8.7: Release Documentation** (0.5 hours)
- Create `RELEASING.md` with:
  - How to create a release
  - Version bumping process (automated)
  - Changelog update process (automated)
  - GitHub Actions workflow
  - Testing checklist
- Add release checklist template
- Acceptance: Release process documented

**Task 8.8: Update README Installation** (0.5 hours)
...
**Task 8.9: Update CHANGELOG.md for Sprint 5** (0.5 hours)
- Add Sprint 5 section to CHANGELOG.md
- Document all major changes:
  - Min/max reformulation fix
  - PATH validation complete
  - Production hardening (error recovery, large models, edge cases)
  - PyPI package published
  - Automated release workflow
  - Documentation (tutorial, FAQ, API reference)
- Follow Keep a Changelog format
- Acceptance: CHANGELOG.md updated with Sprint 5 deliverables
...
- [ ] README updated
- [ ] CHANGELOG.md updated for Sprint 5
- [ ] Checkpoint 3 report completed

#### Acceptance Criteria
- [ ] Version bumping automated and tested
- [ ] Changelog generation automated and tested
- [ ] Workflow runs successfully
- [ ] Package installs from TestPyPI
- [ ] All installation instructions tested
- [ ] RELEASING.md complete
- [ ] CHANGELOG.md includes Sprint 5 changes
- [ ] Checkpoint 3 PASS
...
- **Risk:** Automated scripts might have bugs
- **Mitigation:** Test locally before adding to workflow

#### Follow-On Research Items

**Unknown 4.4:** Version numbering for 1.0.0 release?
- **Priority:** Low
- **Status:** 🔍 INCOMPLETE
- **Summary:** Start at 0.4.0 (Sprint 5), increment to 1.0.0 when production-ready. Semantic versioning: 0.4.0 → 0.5.0 → ... → 1.0.0.
- **Research Needed:** Task 8.1 will decide versioning scheme
...
- Create API documentation site (Sphinx-based)
- Integrate with existing USER_GUIDE.md

#### Tasks

**Task 9.1: Tutorial Planning** (1 hour)
- **Related Unknown:** Unknown 5.2 (🔍 INCOMPLETE) - Critical tutorial topics? - Installation, first example, PATH validation, troubleshooting
...
**Task 9.2: Write Tutorial** (3 hours)
...
**Task 9.4: Troubleshooting Guide** (0.5 hours)
- **Related Unknown:** Unknown 5.3 (🔍 INCOMPLETE) - Troubleshooting guide detail? - Problem → Diagnosis → Solution format with error examples
...
**Task 9.5: API Documentation Site** (2 hours)
- **Related Unknowns:**
  - Unknown 5.1 (✅ RESOLVED) - Sphinx vs MkDocs? - Using Sphinx (decided during Task 9.5)
  - Unknown 5.4 (🔍 INCOMPLETE) - API reference detail level? - Focus on user-facing APIs with usage examples
- Set up Sphinx for API documentation
- Configure `docs/conf.py` for Sphinx
- Add autodoc for all public modules
- Generate API reference from docstrings
- Create index page with navigation
- Build HTML documentation: `make html`
- Configure GitHub Pages or ReadTheDocs deployment
- Acceptance: API documentation site built and deployable
...
- [ ] API documentation site builds successfully
...
- **Risk:** Sphinx setup might have dependency issues
- **Mitigation:** Test build process early, use standard themes

#### Follow-On Research Items

**Unknown 5.1:** Sphinx vs MkDocs for API documentation?
- **Priority:** Low
- **Status:** ✅ RESOLVED - Using Sphinx (decided during Task 9.5)
- **Summary:** Sphinx chosen for better autodoc support and NumPy/SciPy ecosystem compatibility
- **Research Needed:** N/A - resolved during Day 9
- **Deadline:** End of Day 9
- **Note:** KNOWN_UNKNOWNS.md will be updated to reflect RESOLVED status

**Unknown 5.2:** What are the most critical tutorial topics?
- **Priority:** Medium
- **Status:** 🔍 INCOMPLETE
- **Summary:** Installation, first example, PATH validation, troubleshooting, advanced features. Step-by-step guide with complete examples.
- **Research Needed:** Task 9.1 will plan tutorial structure
- **Deadline:** End of Day 9

**Unknown 5.3:** How detailed should the troubleshooting guide be?
- **Priority:** Medium
- **Status:** 🔍 INCOMPLETE
- **Summary:** Problem → Diagnosis → Solution format, include error message examples. Cover common errors, PATH issues, performance problems.
- **Research Needed:** Task 9.4 will enhance troubleshooting guide
- **Deadline:** End of Day 9

**Unknown 5.4:** API reference detail level?
- **Priority:** Low
- **Status:** 🔍 INCOMPLETE
- **Summary:** Public API only vs full internals. Focus on user-facing APIs with usage examples.
- **Research Needed:** Task 9.5 will decide scope during implementation
- **Deadline:** End of Day 9
...
- Priority order:
  ...
  2. High: PyPI package, tutorial, API docs
...
- Check all deliverables from PLAN_FINAL.md:
  - Min/max fix ✅
  - PATH validation ✅
...
- [ ] mypy 0 errors, ruff 0 errors
- [ ] PyPI package functional
- [ ] Documentation complete (tutorial, FAQ, API reference)
...
*All critical and high-priority unknowns resolved during Days 1-9. Any remaining low-priority items deferred to Sprint 6 planning.*
...
- **Mitigation:**
  ...
  - Full day allocated (Day 9)
  - Tutorial and API docs prioritized
  - Day 10 buffer
...
**Risk 7: Release Automation Scripts Have Bugs**
- **Probability:** Medium (new automation)
- **Impact:** Medium
- **Mitigation:**
  - Test scripts locally before adding to workflow
  - Manual fallback for version bumping and changelog
  - TestPyPI testing before production
- **Contingency:** Manual release process for Sprint 5, fix automation for Sprint 6

### Low Risks

**Risk 8: Test Coverage Below Target**
...
**Risk 10: Sphinx Documentation Build Fails**
- **Probability:** Low (standard tooling)
- **Impact:** Low (can defer API docs)
- **Mitigation:**
  - Test Sphinx build early in Day 9
  - Use standard themes and configurations
  - Day 10 buffer for issues
- **Contingency:** Defer API reference site to Sprint 6, ship with tutorial and FAQ only
...
- Key outputs:
  ...
  - Task 8: Large model fixtures (250, 500, 1K vars), performance baselines established
...
**Sphinx/ReadTheDocs:**
- Required for: Day 9 (API documentation site)
- Status: ✅ Standard Python tooling
- Backup: Simple static HTML if deployment issues
...
- ✅ Release automation working (version bumping, changelog generation)
- ✅ CHANGELOG.md updated
...
- **Note:** KNOWN_UNKNOWNS.md has been updated to reflect COMPLETE status

### Resolved During Sprint 5 (1 unknown)

**Unknown 5.1:** Sphinx vs MkDocs for API documentation
- **Status:** ✅ RESOLVED (during Day 9, Task 9.5)
- **Finding:** Sphinx chosen for better autodoc support and NumPy/SciPy ecosystem compatibility
- **Note:** KNOWN_UNKNOWNS.md has been updated to reflect RESOLVED status

### To Be Resolved During Sprint 5 (16 unknowns)

- Unknown 1.2 (Day 1), Unknown 1.4 (Days 1-2), Unknown 1.5 (Day 2)
- Unknown 2.1 (Day 3), Unknown 2.2 (Day 3), Unknown 2.3 (Day 3)
- Unknown 3.4 (Day 4), Unknown 3.5 (Day 4)
- Unknown 3.2 (Day 6) - Research complete, tests to be implemented
- Unknown 3.3 (Day 5) - Only if memory profiling reveals issues
- Unknown 4.1 (Day 7), Unknown 4.2 (Day 7), Unknown 4.3 (Day 7), Unknown 4.4 (Day 8)
- Unknown 5.2 (Day 9), Unknown 5.3 (Day 9), Unknown 5.4 (Day 9)

### Deferred to Sprint 6 (3 unknowns)

- Unknown 2.4: PATH validation in CI/CD (process decision, low priority)
- Unknown 5.1: Resolved during Sprint 5 (Sphinx chosen)
- Unknown 5.4: Scope decided during Sprint 5 (public APIs with examples)
...
- ✅ Unknowns mapped to specific days/tasks with Follow-On Research sections
...
- ✅ Full day for documentation (Day 9)
- ✅ Tutorial, FAQ, and API reference prioritized
...
- **ENHANCED:** Added automated version bumping and changelog generation

**5. Documentation Polish** ✅
- Priority 5, Day 9
- Tutorial, FAQ, troubleshooting
- **ENHANCED:** Added API documentation site (Sphinx-based)
...
**Plan Revised:** November 6, 2025  
**Plan Finalized:** November 6, 2025  
**Sprint Start:** TBD  
