...
**Objective:** Confirm `ISSUE_1334.md` and `ISSUE_1335.md` are still accurate after Sprint 25 fix-in-place series; verify the otpop NLP-warm-started reproducer; determine whether fixing #1334 actually subsumes #1357 (otpop `$171` from Sprint 25 Day 13) or if they are independent.
...
1. **Re-read ISSUE_1334.md and ISSUE_1335.md** — confirm file:line references match current `src/kkt/stationarity.py`:
   ```bash
