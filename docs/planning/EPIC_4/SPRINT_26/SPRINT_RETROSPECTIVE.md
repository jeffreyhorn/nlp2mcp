...
- **7 issues with Phase 0 acceptance gates pre-documented in the issue body** (per PR20): #1378, #1381, #1385, #1388, #1390, #1393, #1398. These are the architectural-redesign tracks filed during Sprint 26 (Days 1, 3, 4, 6, 7, 9, 13) where the Phase 0 gate was authored as part of the issue's filing/reclassification.
...
- **3 issues without Phase 0 yet** (Sprint 27 prep should author them before any src/ implementation effort): #1356 (fawley comp_up subset/superset — fix-surface diagnosis carried forward from Sprint 25), #1357 (otpop comp_up subset/superset — same), #1387 (cclinpts close-and-refile from Day 6 — fix-surface diagnosis not yet hand-derived).
