...
**PR19 caught 1 of the 14 #1398-affected models but missed the other 13:** PR19 (Day 11 CI extension) runs PATH solve on 11 Tier 0/1 canaries + 4 Pattern C target models (camcge, cesam2, fawley, otpop). Of the Day 13-discovered widened scope of #1398 (14 affected models — qdemo7, egypt, ferts, shale, sambal, qsambal, harker, tfordy, dinam, ganges, gangesx, fawley, srpchase, sroute), **only fawley** is in PR19's Pattern C tier; the other 13 are entirely outside PR19 coverage. **Sprint 27 follow-up:** widen the PR19 target list to include the 13 currently-uncovered #1398-affected models (or a representative subset covering the distinct emit shapes — at minimum the 5 new Phase 0 anchor models added in Sprint 27 #1398 work: qdemo7 + ferts + sambal + ganges + sroute, with launch already covered as a Tier 0/1 canary) so similar gate-overreach catches surface at PR-review time, not at end-of-sprint retest.
...
**PR10 violation rationale:** Phase A was a known-risk structural emit change (Sprint 25 SPRINT_RETROSPECTIVE.md §"What Could Be Improved" #3 — `path_syntax_error` 11 → 12 churn risk). PR19 mitigation (CI extension, Day 11) was scoped to canaries + 4 Pattern C target models (camcge / cesam2 / fawley / otpop); the affected non-target models (originally 4 identified, widened to **14** in PR #1399 review — qdemo7, egypt, ferts, shale, sambal, qsambal, harker, tfordy, dinam, ganges, gangesx, fawley, srpchase, sroute) are 13 outside PR19's coverage (fawley is the only one already in PR19's Pattern C tier). The widened-influx outcome is the **same failure-mode shape** that PR19 was designed to prevent on the canary set — just at a broader emit-affected surface than PR19's initial target list. Sprint 27 #1398 + PR19 target-list extension to the 13 currently-uncovered #1398-affected models (or the 5 new Phase 0 anchor models from the #1398 widened-scope comment: qdemo7 + ferts + sambal + ganges + sroute, with launch already covered as a Tier 0/1 canary and fawley already in Pattern C tier) closes this loop.
