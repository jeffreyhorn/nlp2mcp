...
**PR19 didn't catch this:** PR19 (Day 11 CI extension) runs PATH solve only on 11 Tier 0/1 canaries + 4 Pattern C target models. The Day 13-discovered widened scope of #1398 (14 affected models — qdemo7, egypt, ferts, shale, sambal, qsambal, harker, tfordy, dinam, ganges, gangesx, fawley, srpchase, sroute) is entirely outside those tiers. **Sprint 27 follow-up:** widen the PR19 target list to include all 14 #1398-affected models (or a representative subset covering the distinct emit shapes — at minimum the 5 Phase 0 anchor models from #1398: launch [already covered] + qdemo7 + ferts + sambal + ganges + sroute) so similar gate-overreach catches surface at PR-review time, not at end-of-sprint retest.
