...
- **`PLAN.md` §3: P2 must not displace a bucket track** — P4 ganges (Days 8–9 in the original `PLAN.md`; moved earlier to Days 7–9 by this reallocation, §4) is the sprint's only remaining bucket lever.
