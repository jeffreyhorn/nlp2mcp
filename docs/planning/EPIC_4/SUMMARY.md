...
| 36 | 37–38 | v2.0.0 release & Epic 5 planning (camcge dual-consistent Walras) | (planned) | — | — |

## Cross-epic threads (to expand at Epic-4 close)

- **The genuine-floor ramp** (S30 70 → S31 74 → **S32 74** [≥ 75 missed] → **S33 75 (+1, polygon-class emit cold-match)** → **S34 75** [modal flat] → **S35 75** [modal flat through Day 10]): advances **only** via emit-changing cold-matches (S31's polygon +4; S33's sample pruned-var `.l`-init +1), never presolve-methodology reclassification — the Sprint-30 §3 / Sprint-31 §3 conditionality lesson. S32's movers (mine/camcge cold-match, P6 emit) all REPLAN'd/re-triaged; S34–S35 the deep tracks all REPLAN'd/banked (the S32 §3 pattern held — the aspirational S32→S35 ≥78 ramp did **not** realize; actuals flat at 75 since S33).
