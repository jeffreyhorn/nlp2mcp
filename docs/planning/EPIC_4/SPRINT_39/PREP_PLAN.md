...
- [x] The corpus used as the false-positive test set — 179 parsed models; `korcge` is the decisive control, structurally a near-twin of camcge and well-posed
