...
- Sprint-29 diagnostic + design docs that Sprint 30 consumes: `docs/planning/EPIC_4/SPRINT_29/REPLAN_RISK_ASSESSMENT.md` (the Track-A/B/C dispositions), `COLD_CONVEX_COHORT_SURVEY.md` (the Case-b/c partition + the Class-B CGE cluster), `BACKLOG_FIX_SURFACE_ANALYSIS.md`, `docs/planning/EPIC_5/CGE_DEGENERACY_SCOPING.md` (the paper-verified Walras transformation + its §5 open questions)
