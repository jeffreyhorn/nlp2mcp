...
**Decision:** no tunable in-GAMS lever crosses; the PATH-option tuning (INFES 477 → 382) is the concrete **Sprint-31 PATH-consultation hand-off** (2.2). Sprint-30 P2 = the emitted-GAMS forcing scaffold (homotopy/multi-start), not a firm rocket +1 Solve.
