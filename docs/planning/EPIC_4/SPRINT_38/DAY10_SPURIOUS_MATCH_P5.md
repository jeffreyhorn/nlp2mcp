...
| `make test` | ✅ **5211 passed, 10 skipped** (see below) |
...
- `tests/unit` alone → **3725 passed, 0 skipped**: every attribution test ran (9 at the time of that check; the module has since grown to **132 collected cases** across the review rounds).
