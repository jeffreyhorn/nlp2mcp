...
- [x] Combined Sprint 27 effort fits within Priority 7's 6–12h budget — §5 4-scenario table; most-likely path ~11.5–12.5h (high estimate edges past 12h ceiling by ~0.5h, mitigated per §5.1 escalation note); mixed / worst / worst-worst paths all within budget
