...
- The consultation went out **2026-08-26** to `ferris@cs.wisc.edu`, `steve@gams.com`, `sdirkse@gams.com`, carrying three threads: **rocket**, the **11-model licence-capacity ask**, and **`agreste` + `mine` reframed as one question** (two verified-convex LPs whose MCPs PATH declares MS-5 *Locally* Infeasible after ~10 k iterations — structurally odd for a pure LCP). Tracked on **#1462** and **#1443**.
...
- The consultation reply integrated, OR the 2026-09-09 follow-up posted; the 11-model cohort re-tested if licence capacity arrives (Priority 6)
...
## Acceptance Criteria
- **Solve:** ≥ 111 (maintain the S38 close; **+1 → 112 via lnts** [P3] if its hypothesis survives tracing. The **11-model licence-gated cohort's +11 ceiling is explicitly NOT a Sprint-39 projection** — it becomes reachable only if P6's licence ask succeeds)
...
**Note:** Case studies from Sprint 22; consultation submission now in Sprint 40. The rocket PATH-consultation input finalized S32 and submitted from the Sprint-37 carryforward sprint feeds this consultation; the deep emit carryforwards (markov diagonal-Kronecker, sarf symbolic-emit, fawley constraint-index-diagonal, ganges/gangesx multi-root, camcge Walras / Epic 5) are addressed first in the new **Sprint 37** and its **Sprint 38** carryforward — see the inserted sections above.
...
- PATH author availability (Michael Ferris, Steven Dirkse) — **consultation sent 2026-08-26**; a reply is needed by **Sprint 39** (P6 integrates it; follow-up due 2026-09-09 if none). rocket's +1 Solve and the 11-model licence cohort's +11 are both gated on it and must not be projected before it arrives
...
- Sprint 40 depends on Sprint 22 (case studies) and Sprints 38–39 (**the consultation was SENT 2026-08-26** — rocket + the 11-model licence ask + agreste/mine, tracked on #1462/#1443; Sprint 39 P6 integrates any reply or posts the 2026-09-09 follow-up, so this sprint inherits an answered-or-lapsed consultation rather than an unsent one)
