...
| path_syntax_error | ≤2 | ≤2 | 48 | **41** | **20** | **23** | **11**⁴ | **12**⁶ | **17**⁷ | maintain ≤6 | ≤5 | maintain ≤5 |
...
| Parse Rate (pipeline scope) | ~41% | ≥55% | 82.5% | **98.1%** (154/157) | **97.5%** (156/160) | **100.0%** (147/147)³ | **100.0%** (143/143)⁴ | **100.0%** (142/142)⁶ | **100.0%** (142/142)⁷ | ≥100% | ≥100% | ≥100% |
| Translate Rate (of parsed) | ~69% | ~72% | 90.9% | **89.0%** (137/154) | **90.4%** (141/156) | **95.2%** (140/147) | **94.4%** (135/143)⁴ | **93.7%** (133/142)⁶ | **94.4%** (134/142)⁷ | maintain ≥95% | ≥97% | ≥97% |
| Solve Rate (of translated) | ≥52% | ≥52% | 27.5% | **47.4%** (65/137) | **63.1%** (89/141) | **61.4%** (86/140) | **73.3%** (99/135) | **78.2%** (104/133) | **76.9%** (103/134)⁷ | ≥82% | ≥83% | ≥85% |
| Full Pipeline Match (pipeline scope) | ~14% | ≥20% | 10.0% | **19.1%** (30/157) | **29.4%** (47/160) | **33.3%** (49/147)³ | **37.8%** (54/143)⁴ | **42.3%** (60/142)⁶ | **41.5%** (59/142)⁷ | ≥46% | ≥48% | ≥52% |
...
- **2026-05-14:** Sprint 26 final metrics recorded (5/8 acceptance criteria met, 1 STRETCH on Translate +4 STRETCH ≥132 = 134/142). 3 MISS on Solve (−1) / Match (−1) / path_syntax_error (+8) all attributable to a single root cause: Phase A's Pattern C gate predicate fires too broadly on Sums whose body multipliers are already correctly alias-indexed (qdemo7/egypt/ferts/shale regressed to path_syntax_error via `i↔j` swap — filed as Sprint 27 #1398). Updated Rolling KPIs row with S26 actuals + footnote ⁷ documenting the metric movement, the bucket-provenance analysis (4 Phase A side-effects + 4 machine-variance recoveries), and the PR10 re-calibrated error-influx outcome (alias-AD 133% / 4 influx ÷ 3 fixes, above 30% budget — same failure-mode shape PR19 was designed to prevent, just at a broader emit-affected surface than PR19's initial target list). Sprint 26 absorbed 4 close-and-refile reclassifications + 1 in-place carryforward without sprint cancellation: Phase B → Sprint 27 #1381 (Day 3), Priority 4 Option 1 short-circuit → #1385 (Day 4), Priority 3 kand → #1390 (Day 7), Priority 5 #1334 → #1393 + #1335 in-place reopen (Day 9); plus PR19 CI extension shipped Day 11 (PR #1396 merged). New process recommendations from Sprint 26 retrospective: PR20 (Phase 0 acceptance gate — hand-derived KKT before src/ implementation effort), PR21 (prep-task end-to-end emit verification), PR22 (Day-0 / mid-sprint script auto-generating the Day 12 PR14 review list), PR23 (CI-workflow PR self-review checklist). **13 issues labeled `sprint-27` for Sprint 27 backlog** (4 net-new from Sprint 26 reclassifications: #1378 launch PATH numerics + #1381 + #1385 + #1390 + #1393 + #1387 + #1388 = 7 from reclassifications/Sprint 26 work; #1398 net-new from Day 13 Phase A gate discovery; #1335 reopened in-place Day 13 per Day 9 intent; #1356 / #1357 / #1374 carryforward from Sprint 25 sprint-26 label moved to sprint-27 Day 13; #1224 carryforward from earlier sprints).
