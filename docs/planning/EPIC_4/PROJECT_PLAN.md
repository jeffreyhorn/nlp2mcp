...
- **Deliverable:** rocket → match via a documented forcing strategy (+1 Solve / +1 Match) OR a documented "needs a solver-side option beyond nlp2mcp" finding that seeds the Sprint-33 PATH consultation; the forcing scaffold is reusable for the cold-convex Case-c residue.
