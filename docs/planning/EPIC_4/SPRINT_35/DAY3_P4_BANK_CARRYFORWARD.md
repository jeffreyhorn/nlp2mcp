...
Recovery needs, in order, a dedicated effort spanning **three emit/fix layers (1–3)** plus **one optional pipeline tweak (4)** — well beyond a bounded in-sprint attempt:
