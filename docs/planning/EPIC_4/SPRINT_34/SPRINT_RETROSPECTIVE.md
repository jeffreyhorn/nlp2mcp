...
- **The genuine-floor ramp remains conditional, not independent +1s** (the Sprint-30 §3 lesson, re-borne-out). The ≥ 76 step needed a genuine *cold-emit* mover (mine or fawley); both REPLAN'd/deferred; a warm-start fix (P4) yields 0 floor by definition. Flat-75 was the modal outcome the projection named.
