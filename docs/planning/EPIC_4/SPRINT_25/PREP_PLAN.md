...
- **Pattern distribution (revised from Sprint 24):** Pattern A = 6 issues / ~15 models (#1138, #1139, #1140, #1142, #1145, #1150); Pattern C = 2 issues (#1143, #1146); Pattern E = 3 issues (#1141, #1144, #1147) routed out of scope. Patterns B and D are empty.
